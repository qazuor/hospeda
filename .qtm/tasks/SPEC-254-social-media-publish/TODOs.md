...
- [x] **T-041** (complexity: 3) - Build admin social dashboard page (/admin/social)
...
- [x] **T-045** (complexity: 3) - Implement SocialPublishDispatchService — dispatchTarget with retry logic
...
- [x] **T-048** (complexity: 2) - Implement Make callback routes (claim and result)
