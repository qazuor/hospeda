...
- [ ] **T-013** (complexity: 3) - Create DB model files for all 17 social tables
  - One BaseModelImpl-extending model per table; create models/social/index.ts.
  - Blocked by: T-011
  - Blocks: T-014, T-020, T-026, T-027, T-032, T-044

- [ ] **T-014** (complexity: 3) - Create Zod entity schema directories for all 17 social entities
...
- [ ] **T-015** (complexity: 3) - Create seed data files for all catalog entities
  - 9 seed files + JSON fixtures; idempotent upserts; register in runRequiredSeeds.
  - Blocked by: T-012, T-014
  - Blocks: T-016

- [ ] **T-016** (complexity: 3) - Create catalog CRUD services (hashtag, hashtag-set, footer, campaign, batch, audience)
  - 6 services with normalizers + permissions + unit tests.
  - Blocked by: T-014, T-015
  - Blocks: T-017, T-018, T-030

- [ ] **T-017** (complexity: 2) - Create PlatformFormatService and SettingsService
  - Secret masking in listAll; audit log on settings update; warning count on format disable.
  - Blocked by: T-016
  - Blocks: T-018, T-030

- [ ] **T-018** (complexity: 3) - Wire catalog admin API routes (hashtags, hashtag-sets, footers, campaigns, batches, audiences)
  - 6 route files, each with 5 endpoints; register under /api/v1/admin/social.
  - Blocked by: T-016, T-017
  - Blocks: T-019, T-030

- [ ] **T-019** (complexity: 2) - Wire platform-formats and settings admin API routes
...
- [ ] **T-027** (complexity: 3) - Create SocialImagePipelineService
...
- [ ] **T-030** (complexity: 2) - Implement GET /api/v1/admin/social/gpt-action-schema route
...
- [ ] **T-032** (complexity: 1) - Create SocialAuditLogService
...
- [ ] **T-034** (complexity: 3) - Extend SocialPostService — schedule, markReady, pause, unpause, archive
