...
- [x] **T-017** (complexity: 2) - G-3: wire ISR/CDN revalidation into syncFeaturedByEntitlementForOwner [DONE]
  - Blocked by: T-005 · Blocks: T-027
- [x] **T-018** (complexity: 1) - G-3: wire ISR/CDN revalidation into syncFeaturedByEntitlementForAccommodation [DONE]
  - Blocked by: T-005 · Blocks: T-027
...
- [x] **T-021** (complexity: 2) - Unit tests — resolver helpers (T-004) [DONE]
