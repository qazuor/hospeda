...
- [ ] **T-001** (complexity: 2) - Migration: rename featuredByPlan column to featuredByEntitlement
...
- [ ] **T-003** (complexity: 1) - Addon config: add requiresAccommodationTarget flag
...
- [ ] **T-004** (complexity: 3) - Build shared featured-entitlement resolver helpers
...
- [ ] **T-007** (complexity: 3) - Thread accommodationId through confirm flow and write the link row
...
- [ ] **T-013** (complexity: 2) - G-1/G-5: wire apply-scheduled-plan-changes.ts to the union resolver
  - Blocked by: T-005 · Blocks: T-024
- [ ] **T-014** (complexity: 3) - Rename and extend reconcile cron for addon-sourced, per-accommodation drift
