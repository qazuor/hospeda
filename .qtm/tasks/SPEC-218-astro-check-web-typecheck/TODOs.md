...
## Progress: 10/10 tasks (100%) — COMPLETE (PR pending merge)
...
- [x] **T-002** (complexity: 2) - Add compile-time App.Locals regression guard
...
- [x] **T-003** (complexity: 2) - Fix ts(7006) implicit-any params (6) [mechanical]
  - Blocked by: T-001 / Blocks: T-008
- [x] **T-004** (complexity: 2) - Fix ts(2724) imports + ts(2353) interface gaps (BreadcrumbItem.href)
  - Blocked by: T-001 / Blocks: T-008
- [x] **T-005** (complexity: 3) - Fix ts(2322) type-assign mismatches (22)
  - Blocked by: T-001 / Blocks: T-008
- [x] **T-006** (complexity: 3) - Fix ts(2339) non-Locals (21) + ts(2345) args (9) [W6/W8 class — check real bugs]
  - Blocked by: T-001 / Blocks: T-008
- [x] **T-007** (complexity: 2) - Fix ts(2352) conversions (5) + ts(2358) instanceof (1)
  - Blocked by: T-001 / Blocks: T-008

### Testing Phase

- [x] **T-008** (complexity: 1) - Verify astro check exits 0 on full tree
  - Blocked by: T-002..T-007 / Blocks: T-009

### Integration Phase

- [x] **T-009** (complexity: 2) - Wire astro check into web typecheck script + confirm CI
  - Blocked by: T-008 / Blocks: T-010

### Docs Phase

- [x] **T-010** (complexity: 1) - Document .astro typechecking + env.d.ts files invariant
