...
- [ ] **T-001** (complexity: 1) - Verify ANALYTICS_VIEW seed assignment and VIEW_BASIC_STATS entitlement key
  - Verify role seed + entitlement key exist; document findings, no code expected
  - Blocked by: none
  - Blocks: T-004, T-007, T-008, T-013

- [ ] **T-002** (complexity: 1) - Verify entityView schema exports from @repo/schemas
  - Confirm TrackableEntityTypeSchema, EntityViewStatsSchema, EntityViewWindowSchema ('7d'/'30d')
  - Blocked by: none
  - Blocks: T-005, T-006

- [ ] **T-003** (complexity: 1) - Add zodError translation keys for new admin view schemas
...
- [ ] **T-020** (complexity: 2) - Analytics page tests + full typecheck/test/build gate
...
- [ ] **T-021** (complexity: 2) - Real-DB smoke of all four admin endpoints
