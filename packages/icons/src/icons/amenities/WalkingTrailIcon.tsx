...
/**
 * WalkingTrailIcon icon component
 *
 * @example
 * ```tsx
 * import { WalkingTrailIcon } from '@repo/icons';
 *
 * // Basic usage
 * <WalkingTrailIcon />
 *
 * // With custom size and color
 * <WalkingTrailIcon size="lg" color="#3B82F6" />
 *
 * // With Tailwind classes
 * <WalkingTrailIcon className="text-blue-500 hover:text-blue-600" />
 * ```
 */
export const WalkingTrailIcon = ({
    size = 'md',
    color = 'currentColor',
    className = '',
    ...
    <svg
        ...
        {...props}
    >
        <title>{ariaLabel || 'Walking Trail'}</title>
