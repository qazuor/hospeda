 ...
 *
 * - **No i18n columns.** Multi-language menus are HOS-1043, which will retrofit
 *   `name_i18n` exactly as HOS-117 retrofitted `gastronomy_faqs.question_i18n`.
 *   Adding the columns now would ship two columns nothing reads or writes.
