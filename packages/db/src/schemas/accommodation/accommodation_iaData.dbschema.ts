...
export const accommodationIaData = pgTable(
    ...
    (table) => ({
        accommodationIaData_accommodationId_idx: index(
            'accommodationIaData_accommodationId_idx'
        ).on(table.accommodationId),
        accommodationIaData_category_idx: index('accommodationIaData_category_idx').on(
            table.category
        )
    })
);
