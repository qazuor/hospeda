CREATE TABLE "billing_mp_plans" (
	...
	"trial_variant" varchar(10) NOT NULL,
...
CREATE UNIQUE INDEX "billingMpPlans_variant_uniq" ON "billing_mp_plans" USING btree ("commercial_plan_id","billing_interval","trial_variant");--> statement-breakpoint
