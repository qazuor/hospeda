...
CREATE TYPE "public"."conversation_status_enum" AS ENUM('PENDING_VERIFICATION', 'PENDING_OWNER', 'PENDING_GUEST', 'OPEN', 'CLOSED', 'BLOCKED');--> statement-breakpoint
...
CREATE TYPE "public"."entity_type_enum" AS ENUM('ACCOMMODATION', 'DESTINATION', 'USER', 'POST', 'EVENT', 'CONVERSATION', 'REVIEW', 'BILLING_SUBSCRIPTION', 'PAYMENT');--> statement-breakpoint
...
CREATE TYPE "public"."lifecycle_status_enum" AS ENUM('DRAFT', 'ACTIVE', 'INACTIVE', 'ARCHIVED');--> statement-breakpoint
CREATE TYPE "public"."message_sender_type_enum" AS ENUM('GUEST', 'OWNER', 'SYSTEM');--> statement-breakpoint
CREATE TYPE "public"."message_status_enum" AS ENUM('VISIBLE', 'SYSTEM');--> statement-breakpoint
CREATE TYPE "public"."moderation_status_enum" AS ENUM('PENDING', 'APPROVED', 'REJECTED');--> statement-breakpoint
CREATE TYPE "public"."newsletter_campaign_locale_filter_enum" AS ENUM('all', 'es', 'en', 'pt');--> statement-breakpoint
CREATE TYPE "public"."newsletter_campaign_status_enum" AS ENUM('draft', 'sending', 'sent', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."newsletter_channel_enum" AS ENUM('email', 'whatsapp');--> statement-breakpoint
CREATE TYPE "public"."newsletter_content_type_enum" AS ENUM('offers', 'events', 'guides', 'productNews');--> statement-breakpoint
CREATE TYPE "public"."newsletter_delivery_status_enum" AS ENUM('pending', 'delivered', 'failed', 'skipped');--> statement-breakpoint
CREATE TYPE "public"."newsletter_source_enum" AS ENUM('web_footer', 'account_preferences', 'migration');--> statement-breakpoint
CREATE TYPE "public"."newsletter_subscriber_status_enum" AS ENUM('pending_verification', 'active', 'unsubscribed', 'bounced', 'complained');--> statement-breakpoint
CREATE TYPE "public"."notification_recipient_side_enum" AS ENUM('GUEST', 'OWNER');--> statement-breakpoint
...
CREATE TYPE "public"."role_enum" AS ENUM('SUPER_ADMIN', 'ADMIN', 'CLIENT_MANAGER', 'EDITOR', 'HOST', 'SPONSOR', 'USER', 'GUEST', 'SYSTEM');--> statement-breakpoint
...
CREATE TYPE "public"."subscription_status_enum" AS ENUM('active', 'trialing', 'past_due', 'paused', 'cancelled', 'expired', 'pending_provider', 'abandoned');--> statement-breakpoint
...
CREATE TYPE "public"."tag_type" AS ENUM('INTERNAL', 'SYSTEM', 'USER');--> statement-breakpoint
...
CREATE TABLE "accommodations" (
	...
	"owner_suspended" boolean DEFAULT false NOT NULL,
...
CREATE TABLE "conversation_access_tokens" (
	...
	"day15_reminder_sent_at" timestamp with time zone,
	"day25_reminder_sent_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "conversation_access_tokens_token_hash_unique" UNIQUE("token_hash")
);
--> statement-breakpoint
CREATE TABLE "conversation_notification_schedules" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"conversation_id" uuid NOT NULL,
	"recipient_side" "notification_recipient_side_enum" NOT NULL,
	"pending_notification_at" timestamp with time zone NOT NULL,
	"streak_count" integer DEFAULT 1 NOT NULL,
	"streak_started_at" timestamp with time zone NOT NULL,
...
CREATE TABLE "conversations" (
	...
	"anonymous_email_verified" boolean DEFAULT false NOT NULL,
	"anonymous_phone" varchar(50),
	"status" "conversation_status_enum" DEFAULT 'PENDING_VERIFICATION' NOT NULL,
	"block_reason" text,
	"locale" varchar(10) DEFAULT 'es' NOT NULL,
	"archived_by_guest" boolean DEFAULT false NOT NULL,
	"archived_by_owner" boolean DEFAULT false NOT NULL,
	"last_read_at_by_guest" timestamp with time zone,
	"last_read_at_by_owner" timestamp with time zone,
	"first_guest_message_at" timestamp with time zone,
	"first_owner_reply_at" timestamp with time zone,
	"last_activity_at" timestamp with time zone,
	"last_guest_message_at" timestamp with time zone,
	"last_owner_message_at" timestamp with time zone,
	"closed_at" timestamp with time zone,
	"blocked_at" timestamp with time zone,
	"guest_message_count" integer DEFAULT 0 NOT NULL,
	"owner_message_count" integer DEFAULT 0 NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	"created_by_id" uuid,
	"updated_by_id" uuid,
...
CREATE TABLE "messages" (
	...
	"user_id" uuid,
	"body" text NOT NULL,
	"status" "message_status_enum" DEFAULT 'VISIBLE' NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	"created_by_id" uuid,
	"updated_by_id" uuid,
...
CREATE TABLE "billing_addon_purchases" (
	...
	"entitlement_removal_pending" boolean DEFAULT false NOT NULL,
	"needs_entitlement_sync" boolean DEFAULT false NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	"deleted_at" timestamp with time zone
);
...
CREATE TABLE "newsletter_campaign_deliveries" (
	...
	"status" "newsletter_delivery_status_enum" DEFAULT 'pending' NOT NULL,
...
CREATE TABLE "newsletter_campaigns" (
	...
	"status" "newsletter_campaign_status_enum" DEFAULT 'draft' NOT NULL,
	"locale_filter" "newsletter_campaign_locale_filter_enum" DEFAULT 'all' NOT NULL,
	"content_type" "newsletter_content_type_enum",
	"total_recipients" integer,
	"total_softcapped" integer DEFAULT 0 NOT NULL,
	"sent_at" timestamp with time zone,
...
CREATE TABLE "newsletter_subscribers" (
	...
	"channel" "newsletter_channel_enum" DEFAULT 'email' NOT NULL,
	"status" "newsletter_subscriber_status_enum" DEFAULT 'pending_verification' NOT NULL,
	"locale" varchar(10) DEFAULT 'es' NOT NULL,
	"source" "newsletter_source_enum" DEFAULT 'web_footer' NOT NULL,
	"preferences" jsonb DEFAULT '{"offers":true,"events":true,"guides":true,"productNews":true}'::jsonb NOT NULL,
...
CREATE TABLE "sponsorships" (
	...
	"package_id" uuid,
	"sponsorship_status" "sponsorship_status_enum" DEFAULT 'pending' NOT NULL,
	"lifecycle_state" "lifecycle_status_enum" DEFAULT 'ACTIVE' NOT NULL,
...
CREATE TABLE "r_entity_tag" (
	...
	CONSTRAINT "r_entity_tag_tag_id_entity_id_entity_type_assigned_by_id_pk" PRIMARY KEY("tag_id","entity_id","entity_type","assigned_by_id")
);
--> statement-breakpoint
CREATE TABLE "r_post_post_tag" (
	"post_id" uuid NOT NULL,
	"post_tag_id" uuid NOT NULL,
	CONSTRAINT "r_post_post_tag_post_id_post_tag_id_pk" PRIMARY KEY("post_id","post_tag_id")
);
--> statement-breakpoint
CREATE TABLE "tags" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE "user_permission" (
	"user_id" uuid NOT NULL,
	"permission" "permission_enum" NOT NULL,
	"effect" "permission_effect_enum" DEFAULT 'grant' NOT NULL,
...
CREATE TABLE "users" (
	...
	"image_moderation_state" "moderation_status_enum",
	"image_caption" text,
	...
	"set_password_prompted" boolean DEFAULT false NOT NULL,
	"service_suspended" boolean DEFAULT false NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	"created_by_id" uuid,
	"updated_by_id" uuid,
...
CREATE TABLE "billing_checkouts" (
	...
	"payment_id" uuid,
	"subscription_id" uuid,
	"provider_session_ids" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"metadata" jsonb DEFAULT '{}'::jsonb,
	"livemode" boolean DEFAULT true NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "billing_subscription_polling_jobs" (
	...
	"resource_type" varchar(20) DEFAULT 'subscription' NOT NULL,
	"status" varchar(20) DEFAULT 'pending' NOT NULL,
	"attempts" integer DEFAULT 0 NOT NULL,
	"max_attempts" integer DEFAULT 60 NOT NULL,
...
ALTER TABLE "conversation_access_tokens" ADD CONSTRAINT "conversation_access_tokens_conversation_id_conversations_id_fk" FOREIGN KEY ("conversation_id") REFERENCES "public"."conversations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "conversation_notification_schedules" ADD CONSTRAINT "conversation_notification_schedules_conversation_id_conversations_id_fk" FOREIGN KEY ("conversation_id") REFERENCES "public"."conversations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "conversations" ADD CONSTRAINT "conversations_accommodation_id_accommodations_id_fk" FOREIGN KEY ("accommodation_id") REFERENCES "public"."accommodations"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "conversations" ADD CONSTRAINT "conversations_updated_by_id_users_id_fk" FOREIGN KEY ("updated_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "conversations" ADD CONSTRAINT "conversations_deleted_by_id_users_id_fk" FOREIGN KEY ("deleted_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "messages" ADD CONSTRAINT "messages_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "messages" ADD CONSTRAINT "messages_updated_by_id_users_id_fk" FOREIGN KEY ("updated_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "destination_faqs" ADD CONSTRAINT "destination_faqs_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "destination_faqs" ADD CONSTRAINT "destination_faqs_updated_by_id_users_id_fk" FOREIGN KEY ("updated_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "destination_faqs" ADD CONSTRAINT "destination_faqs_deleted_by_id_users_id_fk" FOREIGN KEY ("deleted_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "entity_comments" ADD CONSTRAINT "entity_comments_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "entity_comments" ADD CONSTRAINT "entity_comments_updated_by_id_users_id_fk" FOREIGN KEY ("updated_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "entity_comments" ADD CONSTRAINT "entity_comments_deleted_by_id_users_id_fk" FOREIGN KEY ("deleted_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "event_locations" ADD CONSTRAINT "event_locations_destination_id_destinations_id_fk" FOREIGN KEY ("destination_id") REFERENCES "public"."destinations"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "newsletter_campaigns" ADD CONSTRAINT "newsletter_campaigns_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "newsletter_subscribers" ADD CONSTRAINT "newsletter_subscribers_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "post_tags" ADD CONSTRAINT "post_tags_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "post_tags" ADD CONSTRAINT "post_tags_updated_by_id_users_id_fk" FOREIGN KEY ("updated_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "post_tags" ADD CONSTRAINT "post_tags_deleted_by_id_users_id_fk" FOREIGN KEY ("deleted_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "r_entity_tag" ADD CONSTRAINT "r_entity_tag_assigned_by_id_users_id_fk" FOREIGN KEY ("assigned_by_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "r_post_post_tag" ADD CONSTRAINT "r_post_post_tag_post_id_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "r_post_post_tag" ADD CONSTRAINT "r_post_post_tag_post_tag_id_post_tags_id_fk" FOREIGN KEY ("post_tag_id") REFERENCES "public"."post_tags"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_bookmarks" ADD CONSTRAINT "user_bookmarks_collection_id_user_bookmark_collections_id_fk" FOREIGN KEY ("collection_id") REFERENCES "public"."user_bookmark_collections"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_bookmark_collections" ADD CONSTRAINT "user_bookmark_collections_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_bookmark_collections" ADD CONSTRAINT "user_bookmark_collections_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_bookmark_collections" ADD CONSTRAINT "user_bookmark_collections_updated_by_id_users_id_fk" FOREIGN KEY ("updated_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_bookmark_collections" ADD CONSTRAINT "user_bookmark_collections_deleted_by_id_users_id_fk" FOREIGN KEY ("deleted_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "billing_checkouts" ADD CONSTRAINT "billing_checkouts_customer_id_billing_customers_id_fk" FOREIGN KEY ("customer_id") REFERENCES "public"."billing_customers"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "billing_checkouts" ADD CONSTRAINT "billing_checkouts_payment_id_billing_payments_id_fk" FOREIGN KEY ("payment_id") REFERENCES "public"."billing_payments"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "billing_checkouts" ADD CONSTRAINT "billing_checkouts_subscription_id_billing_subscriptions_id_fk" FOREIGN KEY ("subscription_id") REFERENCES "public"."billing_subscriptions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "billing_subscription_polling_jobs" ADD CONSTRAINT "billing_subscription_polling_jobs_subscription_id_billing_subscriptions_id_fk" FOREIGN KEY ("subscription_id") REFERENCES "public"."billing_subscriptions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "accommodations_ownerSuspended_idx" ON "accommodations" USING btree ("owner_suspended");--> statement-breakpoint
...
CREATE INDEX "accommodation_reviews_lifecycleState_idx" ON "accommodation_reviews" USING btree ("lifecycle_state");--> statement-breakpoint
CREATE INDEX "accommodation_reviews_accommodationId_lifecycleState_idx" ON "accommodation_reviews" USING btree ("accommodation_id","lifecycle_state");--> statement-breakpoint
...
CREATE INDEX "conversation_access_tokens_tokenHash_unique" ON "conversation_access_tokens" USING btree ("token_hash");--> statement-breakpoint
CREATE INDEX "conversation_access_tokens_conversationId_idx" ON "conversation_access_tokens" USING btree ("conversation_id");--> statement-breakpoint
CREATE INDEX "conversation_access_tokens_expiresAt_idx" ON "conversation_access_tokens" USING btree ("expires_at");--> statement-breakpoint
CREATE INDEX "conv_notif_schedules_pending_idx" ON "conversation_notification_schedules" USING btree ("pending_notification_at");--> statement-breakpoint
CREATE INDEX "conv_notif_schedules_conversationId_idx" ON "conversation_notification_schedules" USING btree ("conversation_id");--> statement-breakpoint
CREATE INDEX "conversations_accommodationId_idx" ON "conversations" USING btree ("accommodation_id");--> statement-breakpoint
CREATE INDEX "conversations_userId_idx" ON "conversations" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "conversations_status_idx" ON "conversations" USING btree ("status");--> statement-breakpoint
CREATE INDEX "conversations_lastActivityAt_idx" ON "conversations" USING btree ("last_activity_at");--> statement-breakpoint
CREATE INDEX "conversations_anonymousEmail_idx" ON "conversations" USING btree ("anonymous_email");--> statement-breakpoint
CREATE INDEX "messages_conversationId_idx" ON "messages" USING btree ("conversation_id","created_at");--> statement-breakpoint
CREATE INDEX "messages_conversationId_status_idx" ON "messages" USING btree ("conversation_id","status");--> statement-breakpoint
...
CREATE UNIQUE INDEX "dunningAttempts_subscription_attempt_idx" ON "billing_dunning_attempts" USING btree ("subscription_id","attempt_number") WHERE subscription_id IS NOT NULL;--> statement-breakpoint
...
CREATE INDEX "idx_subscription_events_event_type" ON "billing_subscription_events" USING btree ("event_type","subscription_id","created_at");--> statement-breakpoint
CREATE INDEX "cronRuns_job_started_idx" ON "cron_runs" USING btree ("job_name","started_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "cronRuns_status_created_idx" ON "cron_runs" USING btree ("status","created_at" DESC NULLS LAST);--> statement-breakpoint
...
CREATE INDEX "destinationFaqs_destinationId_idx" ON "destination_faqs" USING btree ("destination_id");--> statement-breakpoint
CREATE INDEX "destinationFaqs_category_idx" ON "destination_faqs" USING btree ("category");--> statement-breakpoint
...
CREATE INDEX "destinationReviews_lifecycleState_idx" ON "destination_reviews" USING btree ("lifecycle_state");--> statement-breakpoint
CREATE INDEX "destination_reviews_destinationId_lifecycleState_idx" ON "destination_reviews" USING btree ("destination_id","lifecycle_state");--> statement-breakpoint
...
CREATE INDEX "idx_entity_comments_entity_active" ON "entity_comments" USING btree ("entity_id","entity_type","deleted_at");--> statement-breakpoint
...
CREATE INDEX "eventLocations_destinationId_idx" ON "event_locations" USING btree ("destination_id");--> statement-breakpoint
...
CREATE INDEX "newsletter_deliveries_campaign_status_idx" ON "newsletter_campaign_deliveries" USING btree ("campaign_id","status");--> statement-breakpoint
CREATE INDEX "newsletter_deliveries_subscriber_delivered_at_idx" ON "newsletter_campaign_deliveries" USING btree ("subscriber_id","delivered_at");--> statement-breakpoint
CREATE INDEX "newsletter_deliveries_provider_message_id_idx" ON "newsletter_campaign_deliveries" USING btree ("provider_message_id");--> statement-breakpoint
CREATE INDEX "newsletter_campaigns_status_idx" ON "newsletter_campaigns" USING btree ("status");--> statement-breakpoint
CREATE INDEX "newsletter_campaigns_created_by_idx" ON "newsletter_campaigns" USING btree ("created_by");--> statement-breakpoint
CREATE INDEX "newsletter_subscribers_status_idx" ON "newsletter_subscribers" USING btree ("status");--> statement-breakpoint
CREATE INDEX "newsletter_subscribers_locale_idx" ON "newsletter_subscribers" USING btree ("locale");--> statement-breakpoint
CREATE INDEX "newsletter_subscribers_channel_idx" ON "newsletter_subscribers" USING btree ("channel");--> statement-breakpoint
...
CREATE INDEX "ownerPromotions_lifecycleState_idx" ON "owner_promotions" USING btree ("lifecycle_state");--> statement-breakpoint
...
CREATE INDEX "ownerPromotions_ownerId_lifecycleState_idx" ON "owner_promotions" USING btree ("owner_id","lifecycle_state");--> statement-breakpoint
CREATE INDEX "ownerPromotions_lifecycleState_validUntil_idx" ON "owner_promotions" USING btree ("lifecycle_state","valid_until");--> statement-breakpoint
...
CREATE INDEX "sponsorships_sponsorshipStatus_idx" ON "sponsorships" USING btree ("sponsorship_status");--> statement-breakpoint
CREATE INDEX "sponsorships_lifecycleState_idx" ON "sponsorships" USING btree ("lifecycle_state");--> statement-breakpoint
...
CREATE INDEX "sponsorships_sponsorshipStatus_lifecycleState_idx" ON "sponsorships" USING btree ("sponsorship_status","lifecycle_state");--> statement-breakpoint
CREATE INDEX "sponsorships_lifecycleState_endsAt_idx" ON "sponsorships" USING btree ("lifecycle_state","ends_at");--> statement-breakpoint
...
CREATE UNIQUE INDEX "post_tags_name_idx" ON "post_tags" USING btree ("name");--> statement-breakpoint
CREATE UNIQUE INDEX "post_tags_slug_idx" ON "post_tags" USING btree ("slug");--> statement-breakpoint
CREATE INDEX "post_tags_lifecycle_idx" ON "post_tags" USING btree ("lifecycle_state");--> statement-breakpoint
CREATE INDEX "r_entity_tag_entity_idx" ON "r_entity_tag" USING btree ("entity_type","entity_id");--> statement-breakpoint
CREATE INDEX "r_entity_tag_assigned_by_idx" ON "r_entity_tag" USING btree ("assigned_by_id");--> statement-breakpoint
CREATE INDEX "r_entity_tag_tagId_idx" ON "r_entity_tag" USING btree ("tag_id");--> statement-breakpoint
CREATE INDEX "r_post_post_tag_postId_idx" ON "r_post_post_tag" USING btree ("post_id");--> statement-breakpoint
CREATE INDEX "r_post_post_tag_postTagId_idx" ON "r_post_post_tag" USING btree ("post_tag_id");--> statement-breakpoint
CREATE UNIQUE INDEX "tags_internal_name_idx" ON "tags" USING btree ("name") WHERE "type" = 'INTERNAL';--> statement-breakpoint
CREATE UNIQUE INDEX "tags_system_name_idx" ON "tags" USING btree ("name") WHERE "type" = 'SYSTEM';--> statement-breakpoint
CREATE UNIQUE INDEX "tags_user_name_idx" ON "tags" USING btree ("owner_id","name") WHERE "type" = 'USER';--> statement-breakpoint
...
CREATE INDEX "users_image_moderation_state_idx" ON "users" USING btree ("image_moderation_state");--> statement-breakpoint
CREATE INDEX "idx_user_bookmarks_collection" ON "user_bookmarks" USING btree ("collection_id");--> statement-breakpoint
CREATE INDEX "idx_user_bookmarks_entity_active" ON "user_bookmarks" USING btree ("entity_id","entity_type","deleted_at");--> statement-breakpoint
CREATE INDEX "idx_user_bookmark_collections_user_active" ON "user_bookmark_collections" USING btree ("user_id","deleted_at");--> statement-breakpoint
...
CREATE INDEX "idx_checkouts_customer" ON "billing_checkouts" USING btree ("customer_id");--> statement-breakpoint
CREATE INDEX "idx_checkouts_status" ON "billing_checkouts" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_checkouts_customer_status" ON "billing_checkouts" USING btree ("customer_id","status");--> statement-breakpoint
CREATE INDEX "idx_checkouts_expiration" ON "billing_checkouts" USING btree ("expires_at");--> statement-breakpoint
...
CREATE INDEX "idx_polling_jobs_due" ON "billing_subscription_polling_jobs" USING btree ("next_poll_at") WHERE status = 'pending';--> statement-breakpoint
CREATE INDEX "idx_polling_jobs_subscription" ON "billing_subscription_polling_jobs" USING btree ("subscription_id");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_polling_jobs_one_active_per_sub" ON "billing_subscription_polling_jobs" USING btree ("subscription_id") WHERE status = 'pending';--> statement-breakpoint
...
CREATE INDEX "idx_subscriptions_pending_plan_change" ON "billing_subscriptions" USING btree ("scheduled_plan_change") WHERE scheduled_plan_change IS NOT NULL AND (scheduled_plan_change->>'status') = 'pending';--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_webhook_events_provider_id" ON "billing_webhook_events" USING btree ("provider_event_id");--> statement-breakpoint
CREATE INDEX "idx_webhook_events_type" ON "billing_webhook_events" USING btree ("type");--> statement-breakpoint
-- SPEC-177 backfill: assign display_order per parent ordered by created_at ASC (0-based).
-- Idempotent: only updates rows where display_order IS NULL so re-running is safe.
...
WHERE df.id = sub.id;--> statement-breakpoint
