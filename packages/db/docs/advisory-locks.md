...
| 43020 | `apps/api/src/cron/jobs/conversation-notification.job.ts` | Prevent overlapping conversation notification dispatch (5-min cron) | `pg_try_advisory_xact_lock` (non-blocking) | SPEC-085 |
