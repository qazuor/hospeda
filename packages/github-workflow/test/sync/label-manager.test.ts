    ...
    describe('LabelManager', () => {
        ...
        describe('warmup', () => {
            it('should create common labels on first call', async () => {
                ...
                expect(mockClient.createLabel).toHaveBeenCalled();
                // Should create universal label + status labels + type labels + comment labels
                const callCount = (mockClient.createLabel as ReturnType<typeof vi.fn>).mock.calls
                    .length;
            ...
            it('should not duplicate labels on subsequent calls', async () => {
                await labelManager.warmup();
                const _firstCallCount = (mockClient.createLabel as ReturnType<typeof vi.fn>).mock
                    .calls.length;

                vi.clearAllMocks();
                await labelManager.warmup();
                const secondCallCount = (mockClient.createLabel as ReturnType<typeof vi.fn>).mock
                    .calls.length;
        ...
        describe('generateForTask', () => {
            ...
            it('should add status label', () => {
                ...
                expect(labelManager.generateForTask(inProgressInput)).toContain(
                    'status:in-progress'
                );
        ...
        describe('generateForComment', () => {
            ...
            it('should generate labels for DEBUG comment', () => {
                const comment = {
                    id: 'comment-3',
                    type: 'DEBUG' as const,
                    content: 'Remove before production',
            ...
            it('should add context-based labels - bug', () => {
                const comment = {
                    id: 'comment-4',
                    type: 'TODO' as const,
                    content: 'Fix the bug in user validation',
                    filePath: 'src/user.ts',
                    lineNumber: 10
                };
            ...
            it('should add context-based labels - security', () => {
                const comment = {
                    id: 'comment-5',
                    type: 'TODO' as const,
                    content: 'Add security validation for passwords',
            ...
            it('should add context-based labels - performance', () => {
                const comment = {
                    id: 'comment-6',
                    type: 'HACK' as const,
                    content: 'Optimize this slow query',
                    filePath: 'src/db.ts',
                    lineNumber: 40
                };
            ...
            it('should add context-based labels - technical-debt', () => {
                const comment = {
                    id: 'comment-7',
                    type: 'HACK' as const,
                    content: 'This is technical debt that needs refactoring',
            ...
            it('should add context-based labels - temporary', () => {
                const comment = {
                    id: 'comment-8',
                    type: 'DEBUG' as const,
                    content: 'Temporary logging for debugging',
                    filePath: 'src/app.ts',
                    lineNumber: 5
                };
        ...
        describe('ensureLabelsExist', () => {
            it('should create labels that do not exist', async () => {
                ...
                expect(mockClient.createLabel).toHaveBeenCalledTimes(labels.length);
            });
