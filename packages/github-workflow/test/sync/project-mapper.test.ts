...
describe('project-mapper', () => {
    describe('ProjectMapper', () => {
        describe('constructor', () => {
            it('should create instance with mappings', () => {
                const mappings: ProjectMapping[] = [{ name: 'Web', patterns: ['apps/web/**'] }];
        ...
        describe('groupByProject', () => {
            ...
            it('should group all unmatched to default project', () => {
                ...
                const groups = mapper.groupByProject(['apps/api/test.ts', 'packages/db/model.ts']);

                expect(groups.size).toBe(1);
                expect(groups.get('General')).toEqual(['apps/api/test.ts', 'packages/db/model.ts']);
            });
        });
        ...
        describe('pattern matching', () => {
            ...
            it('should match single wildcard', () => {
                ...
                expect(mapper.assignProject(['src/nested/file.ts']).project).toBe('Other');
            });
            ...
            it('should match double wildcard', () => {
                ...
                expect(mapper.assignProject(['src/deep/nested/file.ts']).project).toBe('All');
            });
            ...
            it('should match patterns with special regex characters', () => {
                ...
                expect(mapper.assignProject(['src/(component)/file.ts']).project).toBe('Special');
            });
        });
    });
    ...
    describe('DEFAULT_MONOREPO_MAPPINGS', () => {
        ...
        it('should have priorities set', () => {
            for (const mapping of DEFAULT_MONOREPO_MAPPINGS) {
    ...
    describe('createDefaultProjectMapper', () => {
        ...
        it('should assign db files to Database', () => {
            ...
            const assignment = mapper.assignProject(['packages/db/src/models/user.model.ts']);
    ...
    describe('assignProjectToFiles', () => {
        ...
        it('should use custom default project', () => {
            const assignment = assignProjectToFiles(['non-matching.txt'], 'CustomDefault');
