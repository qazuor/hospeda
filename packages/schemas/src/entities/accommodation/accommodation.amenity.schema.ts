import { z } from 'zod';
import { PriceSchema, WithActivityStateSchema, WithAdminInfoSchema } from '../../common';
 ...
 */
export const AccommodationAmenitySchema = WithActivityStateSchema.merge(WithAdminInfoSchema).extend(
    {
