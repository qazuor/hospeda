 ...
 */
export const ProductStatusEnum = z.enum(['draft', 'published', 'archived', 'out_of_stock']);
...
export const ProductSortSchema = z.object({
    sortBy: z.enum(['name', 'price', 'rating', 'createdAt', 'popularity']).default('createdAt'),
...
export const SearchProductSchema =
    ProductFilterSchema.merge(ProductSortSchema).merge(ProductPaginationSchema);
