...
export const bookingSchema = z
    ...
    .refine((data) => !isPastDate(data.checkIn), {
    ...
    .refine((data) => Math.abs(data.totalPrice - data.calculatedPrice) < 0.01, {
...
export const cardPaymentSchema = z
    ...
    .refine((data) => isValidExpiry(data.expiryMonth, data.expiryYear), {
...
export const paymentSchema = z
    ...
    .refine((data) => Math.abs(data.amount - data.bookingAmount) < 0.01, {
...
export const reviewSchema = z
    ...
    .refine((data) => isAppropriateContent(data.comment), {
        message: 'Comment contains inappropriate content or URLs',
        path: ['comment']
    })
    .refine((data) => isAppropriateContent(data.title), {
