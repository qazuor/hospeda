...
// (min===max collapse). This is a deliberate content addition, not drift —
// the frozen baseline was extended in lockstep with `DEFAULT_PROMPTS.search`
// so this gate keeps guarding against ACCIDENTAL future word loss/duplication
// rather than blocking every legitimate prompt edit.
// ---------------------------------------------------------------------------
