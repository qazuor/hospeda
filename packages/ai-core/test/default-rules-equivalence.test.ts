...
// (min===max collapse), and the REFINEMENT vs NEW SEARCH conversational
// framing added by BETA-177 (reset filters on a new query). These are
// deliberate content additions, not drift — the frozen baseline was extended
// in lockstep with `DEFAULT_PROMPTS.search` so this gate keeps guarding against
// ACCIDENTAL future word loss/duplication rather than blocking every legitimate
// prompt edit.
// ---------------------------------------------------------------------------
