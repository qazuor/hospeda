...
describe('Entitlement Configuration', () => {
    ...
    describe('Cross-validation', () => {
        ...
        it('should have all 7 categories totaling to the full definitions count', () => {
            ...
            //
            // NOTE for the next merge conflict here: this total is RE-COUNTED,
            // never incremented. HOS-1044 and HOS-1060 landed in parallel and
            // both branches read 13 — each counting from 12 and adding its own
            // key. Taking either side verbatim would have shipped 13 with 14
            // keys present.
            const commerceCount = 14;
