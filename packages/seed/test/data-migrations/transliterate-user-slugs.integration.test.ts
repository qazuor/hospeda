/**
 * @fileoverview
 * Integration tests for `0044-transliterate-user-slugs.ts` (HOS-375).
 *
 ...
 *
 * Unlike `0041` (scoped to one email), this migration selects EVERY
 ...
 * non-conforming rows depending on whether `0044` has already applied there —
...
import * as transliterateUserSlugs from '../../src/data-migrations/0044-transliterate-user-slugs.js';
...
describe('HOS-375: 0044-transliterate-user-slugs (integration)', () => {
    beforeAll(async () => {
