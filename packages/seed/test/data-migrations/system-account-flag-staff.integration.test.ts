/**
 * @fileoverview
 * Integration tests for `0040-system-account-flag-staff.ts` (HOS-375 T-005).
 *
...
import * as systemAccountFlagStaff from '../../src/data-migrations/0040-system-account-flag-staff.js';
...
describe('HOS-375 T-005: 0040-system-account-flag-staff (integration)', () => {
    beforeAll(async () => {
