/**
 * @fileoverview
 * Integration tests for `0041-editorial-author-slug.ts` (HOS-375 T-006).
 *
...
import * as editorialAuthorSlug from '../../src/data-migrations/0041-editorial-author-slug.js';
...
describe('HOS-375 T-006: 0041-editorial-author-slug (integration)', () => {
    beforeAll(async () => {
