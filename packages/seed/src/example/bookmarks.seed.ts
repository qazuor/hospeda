...
const bookmarkNormalizer = (data: Record<string, unknown>) => {
    ...
    // HACK [cdd6d0e5-ac69-4156-8046-b87442b26de0]: to dont modify all jsons
...
const preProcessBookmark = async (item: unknown, context: SeedContext) => {
    ...
    if (seedUserId) {
        ...
        if (realUserId) {
            ...
            // TODO [15a41456-62d4-4540-8692-08fcb7cd670e]: Get full user data from database if needed
            context.actor = {
                id: realUserId,
