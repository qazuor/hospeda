...
describe('EventLocationService.softDelete', () => {
    ...
    beforeEach(() => {
        model = createTypedModelMock(EventLocationModel, ['findById', 'softDelete']);
    ...
    it('should soft delete an event location (success)', async () => {
