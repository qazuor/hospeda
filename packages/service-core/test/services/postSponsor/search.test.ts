...
describe('PostSponsorService.search', () => {
    ...
    it('should search post sponsors when permissions and input are valid', async () => {
    ...
    it('should return an empty list if no post sponsors match', async () => {
    ...
    it('should search multiple post sponsors', async () => {
        const items = [
