...
> {
    ...
    constructor(ctx: ServiceContext & { model?: SponsorshipPackageModel }) {
     ...
     */
    protected async _executeSearch(params: SponsorshipPackageSearchInput, _actor: Actor) {
     ...
     */
    protected async _executeCount(params: SponsorshipPackageSearchInput, _actor: Actor) {
