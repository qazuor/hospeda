...
export type { RevalidateTargetResult, RevalidationAdapter } from './revalidation.adapter.js';
export { UNRESOLVED_ENVIRONMENT_TARGET, WHOLE_ZONE_TARGET } from './revalidation.adapter.js';
