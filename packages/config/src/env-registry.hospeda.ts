...
export const HOSPEDA_ENV_VARS = [
    ...
    {
        name: 'VITE_FEEDBACK_ENABLED',
        description:
            'Enables the Hospeda feedback FAB widget in the admin app. Gate visibility per environment (dev/preview/production). Admin twin of PUBLIC_FEEDBACK_ENABLED.',
        descriptionEs:
            'Habilita el widget FAB de feedback de Hospeda en el admin. Controlá la visibilidad por entorno (dev/preview/producción). Gemela para admin de PUBLIC_FEEDBACK_ENABLED.',
        type: 'boolean',
        required: false,
        secret: false,
        defaultValue: 'false',
