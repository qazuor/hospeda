/**
 * Markdown and content safety helpers.
 *
 * Provides escape, sanitization, and truncation utilities for safely
 * embedding user-supplied text in Markdown documents (e.g. Linear issues).
 *
