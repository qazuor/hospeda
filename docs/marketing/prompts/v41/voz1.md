# V41 · Tirada de voz — parte A (S1 + S2)
...
**El guion completo son 17,7 s hablados** más pausas, lo que supera el límite de 15 s
de una sola generación de Hailuo. Se parte en dos, cortando justo donde el video ya
tiene un corte real de cámara — el pase de T2 a T3, en 9,5 s.
...
29-32% a SHORT pause.
32-90% he speaks the SECOND sentence.
...
FIRST sentence: [Spanish] ¿Por qué me llamo Hospedín? Por lo que hago: hospedar con
calidez.

SECOND sentence: [Spanish] Mis colores no los inventé yo: son el río, el campo y el sol
del logo de Hospeda.
...
- **Que "Hospeda", la última palabra, quede completa.**
