...
**El guion completo son 9,3 s hablados**, bien por debajo del límite de 15 s de una
sola generación de Hailuo — no hace falta partir la voz en dos tiradas.
...
| `@######ESCENA33#######` | `../../escenas/escena33.png` | 1 |
...
THE PICTURE: start from @######ESCENA33####### and simply keep the character facing the
...
35-40% a SHORT pause.
40-83% he speaks the SECOND sentence.
83-100% SILENCE until the end.

DO NOT SPREAD THE SPEECH ACROSS THE CLIP. The delivery is at a normal conversational
pace and finishes at 83%. Do not slow it down and do not stretch it to fill the 12
seconds.

FIRST sentence: [Spanish] ¿Estás organizando una fiesta, una feria o una fecha
deportiva?

SECOND sentence: [Spanish] Sumala a la agenda de Hospeda para que la gente que visita
la zona la encuentre.
...
- **Que "encuentre", la última palabra, quede completa.**
