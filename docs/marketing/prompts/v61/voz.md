...
**El guion completo son 9,1 s hablados**, bien por debajo del límite de 15 s de una sola
generación de Hailuo — a diferencia de [V40](../v40/voz1.md), acá no hace falta partir el
guion en dos tiradas.
...
26-31% a SHORT pause.
31-53% he speaks the SECOND sentence.
53-58% a SHORT pause.
58-84% he speaks the THIRD sentence.
84-100% SILENCE until the end.

DO NOT SPREAD THE SPEECH ACROSS THE CLIP. The delivery is at a normal conversational pace
and finishes at 84%. Do not slow it down and do not stretch it to fill the 12 seconds.

FIRST sentence: [Spanish] A veces ves algo que te gusta, pero no es el momento.

SECOND sentence: [Spanish] Guardalo. Después lo tenés ahí, esperándote.

THIRD sentence: [Spanish] Cuando vuelvas a pensarlo, ya vas a saber por dónde arrancar.
...
- **Que "arrancar", la última palabra, quede completa.**
