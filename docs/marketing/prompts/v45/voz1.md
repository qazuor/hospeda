# V45 · Tirada de voz — parte A (S1 + S2)
...
**El guion completo son 16,7 s hablados** más pausas, lo que supera el límite de 15 s
de una sola generación de Hailuo. Se parte en dos, cortando justo donde el video ya
tiene un corte real de cámara — el pase de T2 a T3, en 9,0 s.

- **Parte A** (esta) — S1 y S2, para el tramo T1–T2 (0,0 a 9,0 s del video).
...
| `@######ESCENA18#######` | `../../escenas/escena18.png` | 1 |
...
0-36% he speaks the FIRST sentence.
36-41% a SHORT pause.
41-90% he speaks the SECOND sentence.
90-100% SILENCE until the end.

DO NOT SPREAD THE SPEECH ACROSS THE CLIP. The delivery is at a normal conversational
pace and finishes at 90%. Do not slow it down and do not stretch it to fill the 9
seconds.

FIRST sentence: [Spanish] Tu alojamiento ya existe. Ese no es el problema.

SECOND sentence: [Spanish] El problema es que nadie lo encuentra donde en realidad lo
están buscando.
...
- **Que la pausa entre S1 y S2 no se sienta cortada.**
- **Que "buscando", la última palabra, quede completa.**
