...
**El guion completo son 7,7 s hablados**, bien por debajo del límite de 15 s de una
...
| `@######ESCENA27#######` | `../../escenas/escena27.png` | 1 |
...
pace and finishes at 85%. Do not slow it down and do not stretch it to fill the 10
seconds.

FIRST sentence: [Spanish] Acá el asado se hace con leña, no con gas, y no se discute.

SECOND sentence: [Spanish] Es una de esas cosas que en el Litoral no se explican: se
entienden.
...
river sound, NO background noise, NO music, NO sound effects, NO reverb, NO echo. The
...
- **Que "entienden", la última palabra, quede completa.**
