# V42 · Tirada de voz — parte B (S3 + S4)
...
qué son dos tiradas. Cubre el tramo T3–T4 (13,5 a 20,0 s del video).

**Aunque T3 y T4 llevan su propio lip sync**, el audio final del video sale enteramente
de esta tirada — igual que en el resto de la serie.
...
0-43% he speaks the FIRST sentence.
43-47% a SHORT pause.
47-80% he speaks the SECOND sentence.
80-100% SILENCE until the end.

DO NOT SPREAD THE SPEECH ACROSS THE CLIP. The delivery is at a normal conversational
pace and finishes at 80%. Do not slow it down and do not stretch it to fill the 7
seconds.

FIRST sentence: [Spanish] Y vamos sumando destinos a medida que crecemos.

SECOND sentence: [Spanish] Preferimos ir de a poco, pero ir bien.
...
- **Que el timbre sea idéntico al de `voz1.md`.**
- **Que "bien", la última palabra, quede completa.**
