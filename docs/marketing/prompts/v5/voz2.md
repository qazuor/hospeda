...
Continúa donde termina [`voz1.md`](voz1.md). Cubre la frase que sigue en off durante el
hueco de material real, y la frase que se dice en T3, el cierre.

**El texto es el de [El diálogo completo](montaje.md#el-diálogo-completo)**. Los 58
sílabas de este tramo son ~10,2 s; **se pide 12 s**.
...
42-45% a SHORT pause.
45-85% he speaks the SECOND sentence.
85-100% SILENCE until the end.

DO NOT SPREAD THE SPEECH ACROSS THE CLIP. The delivery is at a normal conversational
pace and finishes at 85%. Do not slow it down, do not stretch it to fill the 12 seconds,
...
FIRST sentence: [Spanish] La plataforma se desarrolla acá, hablando con los que reciben
turistas todos los días.

SECOND sentence: [Spanish] Recién estamos empezando, y queremos construirla junto a los
que viven del turismo local.
...
- **Que la última frase esté completa**, incluida la palabra final ("local").
