# V40 · Tirada de voz — parte B (S3 + S4)
...
qué son dos tiradas. Cubre el tramo T3–T4 (8,5 a 19,5 s del video).
...
45-49% a SHORT pause.
49-84% he speaks the SECOND sentence.
84-100% SILENCE until the end.

DO NOT SPREAD THE SPEECH ACROSS THE CLIP. The delivery is at a normal conversational
pace and finishes at 84%. Do not slow it down and do not stretch it to fill the 12
seconds.

FIRST sentence: [Spanish] Acá conocemos las playas, los ríos, la gente y lo que
realmente vale la pena recomendar.

SECOND sentence: [Spanish] A medida que crecemos, vamos a sumar más lugares con el
mismo cuidado.
...
- **Que "cuidado", la última palabra, quede completa.**
