# V40 · Tirada de voz — parte A (S1 + S2)
...
**El guion completo son 17,0 s hablados** más pausas, lo que supera el límite de 15 s
de una sola generación de Hailuo. Se parte en dos, cortando justo donde el video ya
tiene un corte real de cámara — el pase de T2 a T3, en 8,5 s.

- **Parte A** (esta) — S1 y S2, para el tramo T1–T2 (0,0 a 8,5 s del video).
...
31-37% a SHORT pause.
37-88% he speaks the SECOND sentence.
88-100% SILENCE until the end.

DO NOT SPREAD THE SPEECH ACROSS THE CLIP. The delivery is at a normal conversational
pace and finishes at 88%. Do not slow it down and do not stretch it to fill the 9
seconds.

FIRST sentence: [Spanish] Arrancamos por Entre Ríos, y no es casualidad.

SECOND sentence: [Spanish] Preferimos conocer bien un lugar antes que conocer mal
muchos destinos a la vez.
...
- **Que "vez", la última palabra, quede completa.**
