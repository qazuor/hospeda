...
debajo de todo. Timbre idéntico en los 22 segundos, garantizado.

**El texto es el de [El diálogo completo](montaje.md#el-diálogo-completo)**. Al
generarlo, respetar la pausa entre F1 y F2.

**Se pide de 15 s** —el máximo—, aunque el guion hablado son sólo ~9,1 s: es la misma
lógica de V9, que lo único que no se puede permitir es que trunque la última frase, así
que se pide de más y se recorta.
...
0-44% he speaks the FIRST sentence.
44-47% a SHORT pause.
47-64% he speaks the SECOND sentence.
64-100% SILENCE until the end.

DO NOT SPREAD THE SPEECH ACROSS THE CLIP. The delivery is at a normal conversational
pace and finishes at 64%. Do not slow it down, do not stretch it to fill the 15 seconds,
...
FIRST sentence: [Spanish] Conectás tu calendario de Google, de Airbnb, de Booking o el
que uses, y las fechas ocupadas se bloquean solas.

SECOND sentence: [Spanish] Sin planillas y sin anotar en un cuaderno.
...
- **Que la pronunciación de Google, Airbnb y Booking suene natural**, no forzada ni
  deletreada: son las tres marcas que este video sí nombra.
