# Hospeda — Plan de contenido para redes

Documento de producción para diseño y contenidos.
Inventario de funcionalidades de referencia: `funcionalidades-por-usuario.md`
...
Los 3 aspect ratio que vamos a manejar son:

- **9:16** — 1080 x 1920, para historias y estados
- **4:5** — 1080 x 1350, para publicaciones
- **2:3** — 800 x 1200, para mensajes de WhatsApp

En cada diseño se detalla qué opciones de aspect ratio debe tener.

### Tipo de diseño

- **Imagen única** — una sola imagen.
- **Carrusel** — una publicación de varias imágenes, una por ítem. Hay que hacer todas las imágenes.
- **Listado de puntos** — una publicación de una sola imagen, que adentro lista los ítems.

En cada diseño se detalla qué tipo es. Algunos tienen más de un tipo: en esos casos hay que hacer todos los que estén declarados.

### Prioridad

- **1 · Urgente** — lo necesitamos ya, para salir al mercado, lo antes posible
- **2** — lo necesitamos en breve, primer mes
- **3** — segundo a tercer mes
- **4** — algún día 😛
- **5 · No hacer aún** — la pieza se diseña igual, pero **no se publica todavía** porque la funcionalidad no está terminada. Queda guardada y se publica el día que salga.

> La prioridad 5 no significa "poco importante". Significa "bloqueada por la plataforma, no por nosotros". Se diseña ahora para que el día que la funcionalidad esté lista, la pieza salga el mismo día y no dos semanas después.
...
Se usan los de Phosphor — <https://phosphoricons.com/>
...
|---|---|---|
| **Prioridad** | sí | Del 1 al 5, según la escala de arriba |
| **Tipo** | sí | Imagen única · Carrusel · Listado de puntos |
| **Aspect Ratio** | sí | Cuáles hay que hacer |
| **Tag Line** | no | Va arriba del título, chico |
| **Título** | sí | El mensaje principal |
| **Subtítulo** | no | Va abajo del título |
| **Cuerpo** | sí | Texto de apoyo |
| **Items** | no | Solo en carruseles y listados de puntos |
| **Idea** | sí | Qué hay que armar: composición, jerarquía, elementos |
| **Foto/s** | sí | Qué imagen buscar o sacar |
| **CTA** | sí | La acción que le pedimos a la gente |
| **Idioma** | sí | Español, salvo que se aclare lo contrario |

---

## Reglas que no se negocian

1. **Ningún precio va dentro de las imágenes.** La lista de precios está por cambiar. Si el precio queda quemado en la placa, hay que rehacerla entera. Los precios se mencionan solamente en la página web.
...
### Categoría 1 — Genéricas de marca

Piezas que dicen **qué es Hospeda** y **por qué existe**. Son las primeras que salen y las que se van a reciclar todo el año.
...
- **Aspect Ratio**: 4:5
- **Tag Line**: Una sola plataforma
- **Título**: Tres formas de descubrir el Litoral.
- **Cuerpo**: Dónde dormir, dónde comer y qué hacer. Todo junto, en el mismo lugar.
- **Items**:
  1. **Portada** — "Tres formas de descubrir el Litoral", sobre una foto de la región
  2. **Alojamientos** — "Cabañas, casas, hoteles y estancias. Con mapa, filtros y fotos de verdad."
  3. **Gastronomía** — "Restaurantes, bodegas y parrillas de la región, con carta, horarios y opiniones."
  4. **Experiencias** — "Kayak, cabalgatas, catas y paseos. Lo que se hace, no solo dónde se duerme."
- **Idea**: Las 4 placas tienen que verse como una serie: el título siempre en el mismo lugar, la misma tipografía, y lo único que cambia es la foto y un color de acento por cada mundo. Sugerencia de colores de la paleta: verde `#076C05` para alojamientos, naranja `#FC8102` para gastronomía, celeste `#2493B6` para experiencias. Que se note que son familia aunque las veas sueltas.
- **Foto/s**: Una por mundo. Alojamientos: el interior de una cabaña con luz de tarde. Gastronomía: un plato o una mesa servida, tomada desde arriba. Experiencias: un kayak en el río o una cabalgata, en movimiento.
- **CTA**: Entrá a hospeda.com.ar y elegí por dónde empezar
- **Idioma**: Español

---

#### 1.3 · Mirá todo sin registrarte
...
#### 1.4 · El buscador que te entiende
...
#### 1.8 · El clima, con 16 días de anticipación
...
**Acá las plantillas sí corresponden**, a diferencia de destinos. Un destino es fijo y se escribe una vez; un evento cambia cada semana. Lo que se diseña es el molde, y después se rellena.

**Depende de que haya eventos cargados en la plataforma.** Si la agenda está vacía, esta categoría no existe. Por eso va de la mano con la 17.4, que le pide a los organizadores que sumen los suyos.

**Beneficio secundario que vale mucho**: el organizador comparte la publicación de su propio evento. Cada evento publicado trae alcance gratis y contactos nuevos, sin pagar difusión.

---

#### 10.1 · Qué hacer este finde — plantilla semanal

- **Prioridad**: 1
- **Tipo**: Listado de puntos **y** Carrusel
- **Aspect Ratio**: 9:16 y 4:5
- **Tag Line**: *(el fin de semana que toque)*
- **Título**: Qué hacer este finde en el Litoral.
- **Cuerpo**: *(una línea según lo que haya)*
- **Items**: Entre tres y cinco eventos de la semana, con lugar y día. Salen de la agenda cargada en la plataforma.
- **Idea**: **Es la pieza más repetida de todo el plan: sale todas las semanas.** Por eso tiene que ser rapidísima de rellenar — molde fijo, se cambian los textos y listo, veinte minutos. Si armar una edición lleva más de media hora, el formato está mal diseñado y no se va a sostener.
- **Foto/s**: Una general de la región, o una por evento en la versión carrusel.
- **CTA**: Mirá la agenda completa en hospeda.com.ar
- **Idioma**: Español
- **Cuándo se publica**: jueves o viernes temprano. El sábado ya es tarde: la gente decide antes.
- **Si una semana no hay eventos**: no se publica una edición floja. Se saltea y se compensa con otra categoría — publicar tres eventos irrelevantes para cumplir con la frecuencia enseña a la gente a ignorar la serie.

---

#### 10.2 · La agenda del mes — plantilla mensual

- **Prioridad**: 2
- **Tipo**: Listado de puntos
- **Aspect Ratio**: 4:5 y 9:16
- **Tag Line**: *(el mes)*
- **Título**: Todo lo que pasa en *(mes)*.
- **Cuerpo**: Fiestas, ferias y encuentros por toda la provincia.
- **Items**: Los eventos grandes del mes, con fecha y localidad.
- **Idea**: Sale el primer día de cada mes y funciona como resumen guardable — la gente la usa para planear con tiempo. Conviene un diseño tipo calendario, con las fechas bien visibles a la izquierda.
- **Foto/s**: Ninguna, o una general de la región.
- **CTA**: Mirá la agenda completa en hospeda.com.ar
- **Idioma**: Español

---

#### 10.3 · Evento destacado — plantilla
...
- **Subtítulo**: *(fecha y lugar)*
- **Cuerpo**: *(dos renglones de qué es)*
- **Idea**: Una pieza por evento importante. **El nombre del evento y la fecha son lo único que tiene que leerse de lejos** — el resto es contexto. Molde fijo: si todos los eventos se publican con la misma estética, la agenda se vuelve reconocible.
- **Foto/s**: La foto que provee el organizador, o una de la edición anterior.
- **CTA**: Buscá dónde quedarte en hospeda.com.ar
- **Idioma**: Español
- **El CTA es deliberado**: no manda a la ficha del evento, manda a buscar alojamiento. El evento es la excusa; el negocio es que se queden a dormir.
- **Avisarle al organizador** cuando salga: la comparte, y con eso la pieza llega a un público que no nos sigue.

---

#### 10.4 · Falta poco — plantilla recordatorio

- **Prioridad**: 2
- **Tipo**: Imagen única
- **Aspect Ratio**: 9:16 y 2:3
- **Tag Line**: *(la localidad)*
- **Título**: Falta una semana para *(el evento)*.
- **Subtítulo**: ¿Ya tenés dónde quedarte?
- **Cuerpo**: Los alojamientos de la zona se llenan los días del evento.
- **Idea**: Es la pieza que convierte de verdad, porque llega en el momento exacto de la decisión. Formato de historia, urgente y directo. Se publica una semana antes y se puede repetir dos días antes con otro texto.
- **Foto/s**: Del evento, o de un alojamiento de la zona.
- **CTA**: Reservá en hospeda.com.ar
- **Idioma**: Español
- **Ojo**: usarla solo con eventos que efectivamente mueven gente. Con un evento chico, decir que los alojamientos se llenan no es cierto y se nota.

---

#### 10.5 · Cómo estuvo — plantilla

- **Prioridad**: 3
- **Tipo**: Carrusel
- **Aspect Ratio**: 4:5
- **Tag Line**: *(la localidad)*
- **Título**: Así se vivió *(el evento)*.
- **Cuerpo**: *(una línea)*
- **Items**: Cuatro o cinco fotos del evento.
- **Idea**: Cierra el ciclo y sirve para dos cosas: le da material al organizador —que la comparte— y le muestra a los que no fueron lo que se perdieron, que es el mejor argumento para el año que viene. Casi no necesita diseño: son fotos con una placa de portada.
- **Foto/s**: Del evento. Se pueden pedir al organizador o a quienes asistieron.
- **CTA**: Mirá qué se viene en hospeda.com.ar
- **Idioma**: Español
...
El contenido más urgente de todo el plan. Sin alojamientos y negocios publicados no hay nada para mostrarle al turista.

A quién le hablamos: dueños de cabañas, casas, hoteles, restaurantes y experiencias de la región. El tono cambia respecto del resto: acá le hablamos a alguien que vive de esto.

---

#### 12.1 · Llevá tu alojamiento a la vidriera
...
#### 12.3 · Tres motivos para publicar

- **Prioridad**: 1
- **Tipo**: Carrusel (una imagen por ítem) **y** Listado de puntos. Hay que hacer los dos.
- **Aspect Ratio**: 4:5
...
- **Idioma**: Español
- **Antes de publicar**: revisar con alguien el uso del nombre y el logo de Google en una placa publicitaria.

---

#### 12.5 · Llegá al turista de todo el mundo

- **Prioridad**: 1
- **Tipo**: Imagen única
- **Aspect Ratio**: 9:16 y 4:5
- **Título**: Llegá al turista de Argentina, Brasil y todo el mundo.
...
#### 12.6 · Sumá tu restaurante o tu experiencia
...
#### 12.7 · Sos anfitrión y viajás como VIP
...
#### 12.8 · Mirá cómo te va

- **Prioridad**: 2
- **Tipo**: Listado de puntos
- **Aspect Ratio**: 4:5
- **Tag Line**: Números claros
- **Título**: Sabés exactamente cómo le va a tu alojamiento.
- **Cuerpo**: Datos fáciles de leer, sin palabras raras ni tableros imposibles de entender.
- **Items**:
  - Cuánta gente vio tu ficha
  - Cuántos te consultaron este mes
  - Qué tan rápido respondés
  - Cuántos te guardaron en favoritos
  - Cómo estás respecto del resto de la zona
- **Idea**: La lista con un ícono de Phosphor a la izquierda de cada punto, y de fondo la pantalla real de estadísticas bien clarita. Los dos últimos puntos marcados con algún detalle que indique que vienen con los planes más completos, sin decir cuál ni poner precios.
- **Foto/s**: Captura de pantalla real del panel de estadísticas.
- **CTA**: Probá gratis en hospeda.com.ar
- **Idioma**: Español

---

#### 12.9 · Ofertas que se ven
...
#### 12.10 · Que te encuentren en Google
...
#### 12.12 · Las consultas van a tu WhatsApp
...
Y tiene un efecto secundario que vale tanto como el material: **el que colabora se siente parte**. Alguien que mandó una foto de su ciudad después defiende la plataforma sola.

**Tres reglas para que funcione:**

1. **Pedir poco y concreto.** "Mandanos fotos" no lo hace nadie. "¿Tenés una foto del atardecer en la costanera de tu ciudad?" sí.
...
#### 17.1 · Mostranos tu ciudad

- **Prioridad**: 1
- **Tipo**: Imagen única
- **Aspect Ratio**: 9:16, 4:5 y 2:3
- **Tag Line**: Mostrá lo tuyo
- **Título**: ¿Tenés una buena foto de tu ciudad?
- **Subtítulo**: Mandanosla y la publicamos con tu nombre.
- **Cuerpo**: Estamos armando la guía visual del Litoral y queremos que la hagan quienes viven acá.
- **Idea**: **Es la pieza que destraba la categoría de destinos.** El tono es de invitación, no de pedido de auxilio: se convoca a que la gente muestre su lugar, no se avisa que tenemos huecos. Mostrar una foto linda de ejemplo, con el crédito de quien la sacó bien visible.
- **Foto/s**: Una foto buena de un destino, con el crédito de quien la sacó — muestra el ejemplo y a la vez cumple la promesa.
- **CTA**: Mandanos tu foto desde hospeda.com.ar
- **Idioma**: Español
- **Cómo potenciarla**: publicar una versión por destino, nombrando la ciudad. "¿Tenés una foto de Federación?" convierte mucho más que un pedido genérico, y permite ir sumando material de cada lugar.
- **Lo que sostiene el flujo**: cada foto que se publica tiene que llevar el crédito de quien la mandó, y conviene avisarle cuando sale. Si el que colaboró nunca ve su foto publicada ni su nombre, no vuelve a mandar y lo comenta. Pedir permiso por escrito antes de usarla, aunque la hayan mandado para eso: un mensaje alcanza, pero que quede guardado.

---

#### 17.2 · Contanos más de tu ciudad

- **Prioridad**: 2
- **Tipo**: Imagen única
- **Aspect Ratio**: 9:16 y 4:5
- **Tag Line**: Vos sabés más
- **Título**: ¿Qué más deberíamos mostrar de tu ciudad?
- **Subtítulo**: Un lugar, un evento, algo que solo sabe el que vive ahí.
- **Cuerpo**: Vos conocés tu ciudad mejor que nadie. Contanos qué sumarías.
- **Idea**: El ángulo es que el vecino sabe más que cualquier guía, y eso es cierto. Funciona como validación además de como aporte: el que suma un dato queda involucrado con la plataforma.
- **Foto/s**: Ninguna, o un mapa con un signo de pregunta.
- **CTA**: Escribinos desde hospeda.com.ar
- **Idioma**: Español
- **Nota**: es la forma más barata de enriquecer las descripciones de los 22 destinos, que se escribieron desde afuera. La gente aporta gratis y con gusto.

---

#### 17.3 · Buscamos quien escriba
...
- **Cuerpo**: Buscamos gente que cuente qué pasa en su ciudad: eventos, lugares, recomendaciones.
...
- **Idioma**: Español
- **Beneficio doble**: además del contenido, cada autor trae su propio círculo. Es la forma más barata de crecer en ciudades donde todavía no tenemos presencia.

---

#### 17.4 · ¿Hay un evento que no está?
...
#### 17.5 · Recién arrancamos

- **Prioridad**: 1 — es la versión para ahora
- **Tipo**: Imagen única
- **Aspect Ratio**: 9:16 y 4:5
- **Tag Line**: Estamos empezando
- **Título**: Recién arrancamos. Se nota, y está bien.
- **Subtítulo**: Si ves algo que falta o que está mal, decinos.
- **Cuerpo**: Estamos construyendo esto de a poco. Lo que nos digas ahora define cómo queda.
- **Idea**: **La honestidad acá es la estrategia, no una disculpa.** Reconocer que se está empezando desarma la crítica antes de que aparezca, y convierte al que iba a señalar un error en alguien que se siente parte de la construcción. El tono es de entusiasmo, nunca de pedir perdón: es una plataforma nueva, no una plataforma rota.
- **Foto/s**: Ninguna. Tipográfica, sobre color de la paleta.
- **CTA**: Escribinos desde hospeda.com.ar
- **Idioma**: Español
- **Hasta cuándo usarla**: mientras la plataforma esté visiblemente en construcción y falte contenido en varios destinos. **Tiene fecha de vencimiento**: el día que ya esté completa y pulida, esta pieza empieza a jugar en contra —sugiere improvisación donde ya hay solidez— y se reemplaza por la 17.6.

---

#### 17.6 · Viste algo mal, decinos

- **Prioridad**: 4 — es la versión para más adelante
- **Tipo**: Imagen única
- **Aspect Ratio**: 9:16 y 4:5
...
- **Idea**: La misma función que la 17.5 pero con otra postura: acá ya no se admite estar empezando, se ofrece un canal de mantenimiento. El tono es de plataforma sólida que se mantiene al día, no de proyecto en construcción. Convierte una queja en colaboración, que es mucho mejor que un comentario público diciendo que la información está mal.
- **Foto/s**: Ninguna.
- **CTA**: Reportalo desde hospeda.com.ar
- **Idioma**: Español
- **Cuándo reemplaza a la 17.5**: cuando los 22 destinos tengan contenido completo, haya alojamientos publicados en la mayoría y la plataforma no se vea nueva. A partir de ahí, esta es la única de las dos que se publica.
- **Por qué son dos y no una**: el mismo mensaje suena distinto según el momento. "Recién arrancamos" en una plataforma madura suena a excusa; "reportá el error" en una recién nacida suena a que deberíamos haberlo hecho bien y no lo hicimos. Cada una funciona en su etapa y no se mezclan.
