...
| `POST /api/v1/admin/gastronomies/{id}/media` | `gastronomy/admin/addMedia.ts` | none | - | n/a | Register an uploaded URL as a new row. HOS-372: relational commerce media. Admin write; PermissionEnum-gated (COMMERCE_EDIT_ALL), enforced both by the route and by `checkGastronomyCanEditMedia` in the service. |
...
| `POST /api/v1/admin/experiences/{id}/media` | `experience/admin/addMedia.ts` | none | - | n/a | Register an uploaded URL as a new row. HOS-372: relational commerce media. Admin write; PermissionEnum-gated (COMMERCE_EDIT_ALL), enforced both by the route and by `checkExperienceCanEditMedia` in the service. |
