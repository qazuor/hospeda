...
**Completed 2026-04-20 (current session)**: 11 tasks — T-041 + T-048 + T-042 + T-049 + T-043 + T-050 + T-065 (service-core hardDelete tests) + T-066 (API integration tests) + T-068 (reconciliation partial close) + T-026 (seed SSRF allowlist) + T-027 (seed cache hardening)
**Splits applied**: 20 parent tasks split into 45 child tasks (68 total vs 47 original)

**Remaining pending (7 tasks)**:
