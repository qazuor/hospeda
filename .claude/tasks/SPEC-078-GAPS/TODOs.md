...
- ⏸ **GAP-078-066 admin script-src `'https:'` blanket replacement** — DEFERRED by user decision (2026-04-20). `'strict-dynamic'` neutralizes in CSP2+ browsers; CSP1 fallback would require dedicated admin-hardening pass.
...
**Net closure score for Known Follow-ups: 10 closed / 2 deferred-by-decision / 0 open.**
