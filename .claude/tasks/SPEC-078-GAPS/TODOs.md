...
**Completed 2026-04-20 (current session)**: 4 tasks — T-041 (admin raw img migration) + T-048 (web raw img + galleryItems pipeline) + T-042 (getMediaUrl API extensions) + T-049 (web avatar-utils + i18n + race doc)
