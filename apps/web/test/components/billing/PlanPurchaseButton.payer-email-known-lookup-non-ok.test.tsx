/**
 * @file PlanPurchaseButton.payer-email-known-lookup-non-ok.test.tsx
 * @description HOS-1234: a non-ok response from the payer-email-known
 * lookup must fail OPEN — the confirm dialog stays in place, never
 * skipped. Mirrors `PlanPurchaseButton.trial-eligibility-lookup-non-ok.test.tsx`.
 *
...
const CHECKOUT_URL = 'https://mp.com/checkout/payer-email-known-non-ok';
...
describe('PlanPurchaseButton — payer-email-known lookup non-ok (HOS-1234)', () => {
