 ...
 * @description HOS-1234: a network failure (thrown/rejected fetch) on the
 * payer-email-known lookup must fail OPEN — the confirm dialog stays in
 * place, never skipped. Mirrors
 * `PlanPurchaseButton.trial-eligibility-lookup-throws.test.tsx`.
 *
