/**
 * @file FeaturedArticleCard.test.ts
 * @description Source-reading tests for FeaturedArticleCard.astro after the
 * Badge migration (Phase 2). Asserts the inline `mutedColorScheme` literal
 * has been replaced by a call to the shared `getMutedColorScheme()` helper.
 */
...
const src = readFileSync(
    resolve(__dirname, '../../../../src/components/shared/cards/FeaturedArticleCard.astro'),
    'utf8'
);

describe('FeaturedArticleCard.astro — Badge migration', () => {
    describe('imports', () => {
