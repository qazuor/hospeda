...
describe('AccordionFAQ.client.tsx', () => {
    describe('Props', () => {
        it('should accept items prop', () => {
            render(<AccordionFAQ items={mockItems} />);
        ...
        it('should default allowMultiple to false', () => {
            const { container } = render(<AccordionFAQ items={mockItems} />);
    ...
    describe('Edge Cases', () => {
        it('should handle empty items array', () => {
            const { container } = render(<AccordionFAQ items={[]} />);
        ...
        it('should handle single item', () => {
            ...
            render(<AccordionFAQ items={singleItem} />);
        ...
        it('should handle items with long text', () => {
            ...
            render(<AccordionFAQ items={longTextItems} />);
        ...
        it('should handle items with special characters', () => {
            ...
            render(<AccordionFAQ items={specialItems} />);
