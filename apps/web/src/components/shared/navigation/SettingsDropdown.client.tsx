...
export function SettingsDropdown({
    ...
    return (
        <div className={styles.wrapper}>
            ...
            {isOpen && (
                // biome-ignore lint/a11y/useSemanticElements: <fieldset> is only for form-control groups; this is a settings popover panel, not a form control — role="group" is the correct WAI-ARIA labeled-group pattern here.
                <div
                    ref={popoverRef}
                    role="group"
                    aria-label={texts.openSettings}
