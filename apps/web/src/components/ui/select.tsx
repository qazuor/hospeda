...
function SelectTrigger({
    ...
    size?: 'sm' | 'default';
    /** Override the chevron icon color (defaults to duotone brand color) */
    chevronColor?: string;
}) {
    return (
        <SelectPrimitive.Trigger
            ...
            className={cn(
                ...
                'aria-invalid:border-destructive aria-invalid:ring-destructive/20 data-[size=default]:h-9 data-[size=sm]:h-8 data-[placeholder]:text-muted-foreground',
        ...
        >
            ...
            <SelectPrimitive.Icon asChild>
                <ChevronDownIcon
                    ...
                    weight={chevronColor ? 'regular' : 'duotone'}
