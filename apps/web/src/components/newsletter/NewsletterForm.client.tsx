                ...
                <div className={styles.inputRow}>
                    ...
                    <div className={styles.inputWrapper}>
                        {isAuthed ? (
                            ...
                            // biome-ignore lint/a11y/useSemanticElements: <fieldset> is only for form-control groups; this is a readonly static-text display, not a form control — role="group" is the correct WAI-ARIA labeled-group pattern here.
                            <div
