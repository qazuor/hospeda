...
export function toAccommodationCardProps({
    ...
    const priceData = item.price as { price?: number; currency?: string } | undefined;
 ...
 * Includes optional enriched fields (attractions, gallery, coordinates, ratingDimensions).
 *
