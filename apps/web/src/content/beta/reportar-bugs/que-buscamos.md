...
- Pagué y no me apareció confirmación
- Recibí o no recibí el email de confirmación

> **Nota sobre pagos:** vas a usar **tarjetas de prueba** que no son reales. Mirá [Suscripción y pagos](/beta/host/suscripcion-y-pagos/). **NO USES TU TARJETA REAL** salvo que seas uno de los 2 testers de [pago real](/beta/pago-real/introduccion/).

## Próximo paso

Una vez que sabés qué buscar, te recomendamos **[Cómo intentar romper el sistema](/beta/reportar-bugs/intentar-romper/)** — la parte más divertida.
