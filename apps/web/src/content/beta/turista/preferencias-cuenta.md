...
Esta es una sección de pruebas variadas. Probá todo lo que puedas — son cosas chicas pero importantes.
...
> 📋 **Reportá:** anotá la página y qué texto viste mal traducido. Si te animás, copiá el texto exacto al reporte.

## Cambiar tema visual

Cerca del selector de idioma hay un control con **3 opciones**: **Claro · Sistema · Oscuro** (con iconos de Sol · Engranaje · Luna).
...
- ¿Se ve bien en cada uno?
- ¿Algún texto queda ilegible (poco contraste)?
- ¿Algún ícono o imagen queda raro?
- Si elegís **Sistema**, cambiá el tema de tu OS (claro/oscuro) y mirá si el sitio se actualiza solo sin recargar.

## Editar tu perfil

1. Menú de usuario → **"Mi Perfil"** o **"Editar perfil"**.
2. Cambiá:
   - **Nombre para mostrar** / Nombre / Apellido
   - **Teléfono**
   - **Biografía** (máximo 1000 caracteres)
3. Si te deja, cambiá el **avatar** (formato JPEG, PNG o WebP, máx 5 MB).
4. Apretá **"Guardar cambios"**.
5. Recargá la página y fijate si guardó.

> 📋 **Reportá:**
>
> - Si algo no se guardó
> - Si dio error al guardar
> - Si la foto no se subió (probá con imagen menor a 5MB y formato JPEG/PNG/WebP)
> - Si el helper "El correo electrónico no puede ser modificado" tiene sentido
...
> 📋 **Reportá** exactamente lo que viste (mensaje, comportamiento del formulario).
...
> 📋 **Reportá:**
>
> - Si después de suscribirte no aparece confirmación visible
...
- **Análisis** (Sentry, monitoreo de errores)
- **Marketing** (reservado, actualmente no se usa)

En la vista inicial vas a ver **3 botones**:
