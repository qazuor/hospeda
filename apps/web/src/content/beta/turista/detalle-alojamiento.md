---
title: Ver el detalle de un alojamiento
description: Qué mirar en la página de detalle — galería, mapa, comodidades, reseñas y favoritos.
order: 3
role: turista
...
Hacé clic en cualquier alojamiento del catálogo. Te lleva a la página de detalle. **Te queremos ver explorando libremente.**
...
> 📋 **Reportá:**
>
> - Cualquier cosa que se vea rara
> - Si una foto no carga o sale rota
> - Si el mapa no aparece o el pin no marca el lugar
> - Errores de ortografía o texto cortado
> - En celular, si alguna parte se ve desbordada
> - Si tardó mucho en cargar
> - Si el botón de favorito no responde o no guarda

## Próximo paso

Probá **[contactar al propietario](/beta/turista/contactar-host/)** usando el formulario de mensaje.
