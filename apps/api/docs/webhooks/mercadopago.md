...
- [MP Sandbox Ops Runbook](../../../../docs/migration/mercadopago-sandbox-runbook.md) — full operator guide: dashboard setup, sandbox test-user creation, webhook inspection, and rollback procedures
