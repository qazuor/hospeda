/**
 * Unit/integration tests for GET /api/v1/admin/accommodations/:id/media
 * List accommodation gallery photos — Admin endpoint (SPEC-204)
 *
 * Coverage:
 ...
 *
 * @module test/routes/accommodation-get-media
 */
...
// Tests
// ---------------------------------------------------------------------------
describe('GET /api/v1/admin/accommodations/:id/media — getMedia (SPEC-204)', () => {
    let app: AppOpenAPI;
