/**
 * SPEC-187 regression — public accommodation list must NOT expose richDescription.
 *
 ...
 * the field must be absent from every returned item regardless of the owner's plan.
 *
...
const ACCOMMODATION_WITH_RICH = {
    ...
    slug: 'premium-lodge-list',
    name: 'Premium Lodge (list)',
    ...
    ownerId: 'eeeeeeee-0000-4000-8000-000000000004',
    visibility: 'PUBLIC',
...
/**
 * Stub out the quick-amenity resolver so it does not attempt DB lookups.
 */
 ...
 * The handler signature for createPublicListRoute includes (ctx, params, body, query).
 */
vi.mock('../../../../src/utils/route-factory', () => ({
    createPublicListRoute: (options: {
        ...
        app[options.method](honoPath, async (c) => {
            ...
            // List routes return { items, pagination } — wrap in the standard envelope.
...
describe('publicListAccommodationsRoute — SPEC-187 richDescription must be absent', () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });
