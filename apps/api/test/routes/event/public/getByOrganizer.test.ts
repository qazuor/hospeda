/**
 * Regression tests for `GET /api/v1/public/events/organizer/{organizerId}`.
 *
 * The bug: the handler returned `EventService.getByOrganizer`'s output
 ...
 * so this endpoint answered **500 for every organizer**, from the day it
...
const BASE = '/api/v1/public/events/organizer';
const VALID_UUID = 'f6f6f6f6-f6f6-4f6f-af6f-f6f6f6f6f6f6';
...
describe('GET /api/v1/public/events/organizer/{organizerId}', () => {
    let app: AppOpenAPI;
    ...
    it('does not require authentication', async () => {
        // It backs a public organizer page; a 401/403 here would leave the
    ...
    it('rejects an organizerId that is not a UUID', async () => {
