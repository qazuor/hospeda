/**
 * Tests for GET /api/v1/public/points-of-interest/:id
 *
 * Covers: route registration, public access, UUID validation, and
 * response shape. Mirrors `test/routes/gastronomy/public/getById.test.ts`.
 */
...
describe('GET /api/v1/public/points-of-interest/:id', () => {
    let app: AppOpenAPI;
    ...
    describe('HTTP Method Restrictions', () => {
        it('should reject DELETE requests (no admin/protected tier — NG-5)', async () => {
            const res = await app.request(`${BASE}/${VALID_UUID}`, {
                method: 'DELETE',
                headers: { 'user-agent': 'vitest', accept: 'application/json' }
            });
