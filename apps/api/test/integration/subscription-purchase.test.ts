...
describe('Subscription Purchase and Plan Activation E2E', () => {
     ...
     */
    describe.todo(
        '1. Checkout Session Creation: Requires billing.checkout API not available in current QZPay version'
    );
     ...
     */
    describe.todo(
        '6. Checkout Session Expiry: Requires billing.checkout API not available in current QZPay version'
    );
