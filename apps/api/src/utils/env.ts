...
const ApiEnvSchema = ApiEnvBaseSchema.superRefine((data, ctx) => {
    ...
    if (data.NODE_ENV === 'production') {
        const requiredInProd: ReadonlyArray<readonly [string, string | undefined]> = [
            ...
            ['HOSPEDA_CLOUDINARY_CLOUD_NAME', data.HOSPEDA_CLOUDINARY_CLOUD_NAME],
            ['HOSPEDA_CLOUDINARY_API_KEY', data.HOSPEDA_CLOUDINARY_API_KEY],
            ['HOSPEDA_CLOUDINARY_API_SECRET', data.HOSPEDA_CLOUDINARY_API_SECRET],
