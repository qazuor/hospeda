 ...
 */
export const adminAddPostMediaRoute = createAdminRoute({
    method: 'post',
    path: '/{id}/media',
    summary: 'Add photo to post gallery (admin)',
    description:
        'Registers an already-uploaded URL as a new post_media row. ' + 'Requires POST_UPDATE.',
    tags: ['Post', 'Media'],
