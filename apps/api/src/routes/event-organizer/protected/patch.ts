/**
 * Protected patch event organizer endpoint
...
/**
 * PATCH /api/v1/protected/event-organizers/:id
 * Patch event organizer - Protected endpoint with ownership check
 */
export const protectedPatchEventOrganizerRoute = createProtectedRoute({
    method: 'patch',
    path: '/{id}',
    summary: 'Patch event organizer',
    description:
        'Partially updates an event organizer. Requires ownership or EVENT_ORGANIZER_UPDATE permission.',
