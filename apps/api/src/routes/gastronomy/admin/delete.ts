 ...
 *
 * Requires GASTRONOMY_DELETE (or the legacy COMMERCE_DELETE) permission. The service layer (`_canSoftDelete`)
...
export const adminDeleteGastronomyRoute = createAdminRoute({
    ...
    description:
        'Soft deletes a gastronomy listing. Requires GASTRONOMY_DELETE (or the legacy COMMERCE_DELETE) permission.',
    tags: ['Gastronomy'],
