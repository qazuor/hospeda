import { PromotionSchema, SearchPromotionsSchema } from '@repo/schemas';
...
export const promotionListRoute = createListRoute({
    method: 'get',
    path: '/',
    summary: 'List promotions',
    description: 'Returns a paginated list of promotions',
    tags: ['Promotions'],
    requestQuery: SearchPromotionsSchema.shape,
