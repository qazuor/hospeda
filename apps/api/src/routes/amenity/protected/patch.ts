/**
 * Protected patch amenity endpoint
...
/**
 * PATCH /api/v1/protected/amenities/:id
 * Patch amenity - Protected endpoint
 */
export const protectedPatchAmenityRoute = createProtectedRoute({
    method: 'patch',
    path: '/{id}',
    summary: 'Patch amenity',
    description: 'Partially updates an existing amenity. Requires AMENITY_UPDATE permission.',
    tags: ['Amenities'],
    requiredPermissions: [PermissionEnum.AMENITY_UPDATE],
    requestParams: {
        id: AmenityIdSchema
    },
    requestBody: AmenityUpdateHttpSchema.partial(),
