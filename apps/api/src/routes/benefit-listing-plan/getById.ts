...
export const benefitListingPlanGetByIdRoute = createCRUDRoute({
    method: 'get',
    path: '/:id',
    summary: 'Get benefit listing plan by ID',
    description: 'Returns a single benefit listing plan by ID',
