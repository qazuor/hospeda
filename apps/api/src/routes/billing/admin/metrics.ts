/**
 * Admin Billing Metrics Routes
 *
 * REST API routes for billing analytics and metrics.
 * All routes are admin-only and mounted under /api/v1/admin/billing/metrics.
 *
 ...
 *
 * @module routes/billing/admin/metrics
 */
 ...
 */
export const adminMetricsRouter = createRouter();

adminMetricsRouter.route('/', getDashboardMetricsRoute);
