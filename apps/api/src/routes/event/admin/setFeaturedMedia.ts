/**
 * PUT /api/v1/admin/events/:id/media/:mediaId/featured
 ...
 */
import { EventMediaSingleOutputSchema, PermissionEnum } from '@repo/schemas';
 ...
 */
export const adminSetFeaturedEventMediaRoute = createAdminRoute({
    method: 'put',
    path: '/{id}/media/{mediaId}/featured',
    summary: 'Set featured photo for event gallery (admin)',
    description:
        ...
        'photo to visible first. Requires EVENT_UPDATE. ' +
