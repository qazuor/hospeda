import { HttpListNotificationsSchema, NotificationSchema } from '@repo/schemas';
...
export const notificationListRoute = createListRoute({
    method: 'get',
    path: '/',
    summary: 'List notifications',
    description: 'Returns a paginated list of notifications',
    tags: ['Notifications'],
    requestQuery: HttpListNotificationsSchema.shape,
