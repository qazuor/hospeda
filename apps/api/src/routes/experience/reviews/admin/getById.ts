 ...
 *
 * Requires EXPERIENCE_MODERATE_REVIEW (or the legacy COMMERCE_MODERATE_REVIEW) permission.
 */
export const adminGetExperienceReviewByIdRoute = createAdminRoute({
    ...
    description:
        'Retrieves full experience review information including moderation fields. Requires EXPERIENCE_MODERATE_REVIEW (or the legacy COMMERCE_MODERATE_REVIEW).',
