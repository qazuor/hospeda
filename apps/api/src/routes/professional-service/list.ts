import { HttpSearchProfessionalServicesSchema, ProfessionalServiceSchema } from '@repo/schemas';
...
export const professionalServiceListRoute = createListRoute({
    method: 'get',
    path: '/',
    summary: 'List professional services',
    description: 'Returns a paginated list of professional services',
    tags: ['Professional Services'],
    requestQuery: HttpSearchProfessionalServicesSchema.shape,
