/**
 * Admin batch get users endpoint
 * Returns full user information for multiple users
 */
import {
    PermissionEnum,
 ...
 * Get multiple users by IDs - Admin endpoint
 */
export const adminUserBatchRoute = createAdminRoute({
    method: 'post',
    path: '/batch',
    summary: 'Get multiple users by IDs (admin)',
    description: 'Retrieves multiple users by their IDs with full admin details',
    tags: ['Users'],
