...
/**
 * GET /api/v1/sponsorships/:id/analytics
 * Get sponsorship analytics - Protected endpoint
 */
export const getSponsorshipAnalyticsRoute = createProtectedRoute({
    method: 'get',
    path: '/{id}/analytics',
    summary: 'Get sponsorship analytics',
    description:
        'Retrieves analytics data for a sponsorship. Requires SPONSORSHIP_READ permission.',
    tags: ['Sponsorships'],
    ...
    handler: async (ctx: Context, params: Record<string, unknown>) => {
        ...
        if (!result.data) {
            throw new ServiceError('NOT_FOUND' as ServiceErrorCode, 'Sponsorship not found');
        }
