 ...
 */
import { SponsorshipIdSchema, SponsorshipProtectedSchema } from '@repo/schemas';
 ...
 */
export const protectedSponsorshipGetByIdRoute = createProtectedRoute({
    method: 'get',
    path: '/{id}',
    ...
    responseSchema: SponsorshipProtectedSchema.nullable(),
