        ...
        <Card>
            ...
            <CardContent>
                {isLoading ? (
                    <AiUsageBlockState
                        status="loading"
                        title={t('admin-pages.ai.usage.featureModel.chartLoading')}
                    />
                ) : isError ? (
                    <AiUsageBlockState
                        status="error"
                        title={t('admin-pages.ai.usage.featureModel.chartLoadError')}
                    ...
                    <AiUsageBlockState
                        status="empty"
                        title={t('admin-pages.ai.usage.featureModel.chartEmpty')}
