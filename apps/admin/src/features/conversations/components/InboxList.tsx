                    ...
                    <tbody>
                        {isLoading
                            ...
                            : table.getRowModel().rows.map((row) => {
                                  ...
                                  return (
                                      // biome-ignore lint/a11y/useSemanticElements: clickable table rows are the established admin list pattern; full keyboard support via onKeyDown, <tr> cannot be replaced with <button> inside a <table>
                                      <tr
                                          key={row.id}
