 ...
 *
 * HOS-693 §6.2 removed the "Provision owner" / "Approve & provision" dialogs
 * (and their coverage here) along with the admin routes they called — see
 * `CommerceLeadInbox`'s module doc.
 *
