...
function UserActivityPage() {
    ...
    return (
        <UserSiblingPageShell userId={id}>
            <ActivityBody userId={id} />
        </UserSiblingPageShell>
    );
}

function ActivityBody({ userId }: { readonly userId: string }) {
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-sm">
                                    {t('admin-pages.access.users.activity.accountCreatedDesc')}
                                </p>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-2">
                            <p className="font-medium">
                                {formatLongDate({
                                    date: user.createdAt as string | Date | null | undefined,
                                    locale
                                })}
                            </p>
                            <Badge
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-2">
                            <p className="font-medium">
                                {formatLongDate({
                                    date: user.updatedAt as string | Date | null | undefined,
                                    locale
                                })}
                            </p>
                            <Badge
