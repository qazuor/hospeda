...
vi.mock('@repo/icons', () => {
    ...
    return {
        ...
        // Additional icons discovered during SPEC-209 T-005 (healthz test import chain)
        AddressIcon: stub('AddressIcon'),
        AlertsIcon: stub('AlertsIcon'),
        AudioIcon: stub('AudioIcon'),
        ConfigurationIcon: stub('ConfigurationIcon'),
        CurrentIcon: stub('CurrentIcon'),
        DarkThemeIcon: stub('DarkThemeIcon'),
        DateIcon: stub('DateIcon'),
        DocumentIcon: stub('DocumentIcon'),
        FacebookIcon: stub('FacebookIcon'),
        FallbackIcon: stub('FallbackIcon'),
        FavoriteIcon: stub('FavoriteIcon'),
        FieldHelpIcon: stub('FieldHelpIcon'),
        GalleryIcon: stub('GalleryIcon'),
        HamburgerIcon: stub('HamburgerIcon'),
        InstagramIcon: stub('InstagramIcon'),
        ItemIcon: stub('ItemIcon'),
        LightThemeIcon: stub('LightThemeIcon'),
        LinkedInIcon: stub('LinkedInIcon'),
        LockIcon: stub('LockIcon'),
        LogoutIcon: stub('LogoutIcon'),
        LogsIcon: stub('LogsIcon'),
        MinimizeIcon: stub('MinimizeIcon'),
        MinusIcon: stub('MinusIcon'),
        MonitorIcon: stub('MonitorIcon'),
        MoonIcon: stub('MoonIcon'),
        NewsletterIcon: stub('NewsletterIcon'),
        OptionIcon: stub('OptionIcon'),
        PaletteIcon: stub('PaletteIcon'),
        PdfIcon: stub('PdfIcon'),
        PermissionIcon: stub('PermissionIcon'),
        PhIcon: stub('PhIcon'),
        PoolIcon: stub('PoolIcon'),
        PostSponsorshipIcon: stub('PostSponsorshipIcon'),
        QuotesIcon: stub('QuotesIcon'),
        ShoppingCartIcon: stub('ShoppingCartIcon'),
        SunIcon: stub('SunIcon'),
        SynchronizeIcon: stub('SynchronizeIcon'),
        TagIcon: stub('TagIcon'),
        TiktokIcon: stub('TiktokIcon'),
        TriggerIcon: stub('TriggerIcon'),
        TypeIcon: stub('TypeIcon'),
        VideoIcon: stub('VideoIcon'),
        WhatsappIcon: stub('WhatsappIcon'),
        WifiIcon: stub('WifiIcon'),
        YoutubeIcon: stub('YoutubeIcon'),
        ZoomOutIcon: stub('ZoomOutIcon')
    };
});
