...
import * as mod from '../../../../src/routes/_authed/sponsors/$id_.edit';

const uploadEntityImageMutateAsync = vi.fn().mockResolvedValue({
    url: 'https://cdn.example.com/sponsor-logo.jpg',
    publicId: 'post-sponsor/logo',
    width: 512,
    height: 512
});
...
vi.mock('@/features/sponsors/hooks/useSponsorPage', () => ({
    useSponsorPage: () => ({ entity: null, isLoading: false, error: null, permissions: {} })
}));
...
describe('Route /_authed/sponsors/$id_/edit', () => {
    it('wires the logo field to sponsorLogo uploads', async () => {
        ...
        expect(url).toBe('https://cdn.example.com/sponsor-logo.jpg');
