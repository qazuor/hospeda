...
# Evaluate migrating apps/web from custom Zod env layer to astro:env

> Migrated from `.qtm/specs/SPEC-133-evaluate-astro-env/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-7.
