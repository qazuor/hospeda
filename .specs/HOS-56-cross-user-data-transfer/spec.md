...
# Cross-user data transfer (entity ownership migration A → B)

> Migrated from `.qtm/specs/SPEC-279-cross-user-data-transfer/spec.md` on 2026-07-02 as part of the Linear tracking migration. Canonical tracking is now HOS-56.
>
