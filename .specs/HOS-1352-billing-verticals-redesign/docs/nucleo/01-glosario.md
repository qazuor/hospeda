...
> **quince** motivos distintos sobre el mismo sujeto (cap. 02 (billing) §2.5) y **seis de ellos
...
| 6 | el **listado accionable** | cap. 19 (billing) §6 | ordena por motivo, pone adelante los **seis** que devuelven plata (cap. 19 §6) y muestra **todos los pagos colgados de la marca con su monto total** y **el default de lo que el sistema propone** (`DEC-RF-003`) — **que desde `DEC-RF-006` se lee por motivo en los quince**, porque el único que no se leía así, el que abre `S21`, se partió en **dos** motivos: el **14** propone no devolver y el **15** devolver (cap. 02 (billing) §2.5, cap. 03 (billing) §3.2) |
