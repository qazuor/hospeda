...
| Estado | Filas |
|---|---|
| `VERIFIED` | **49** — las nuevas del 2026-09-16: **`PS-5`** (reanudar cambia sólo el `status`), **`RN-1`** (la renovación cobra, con 33 min de lag), **`EX-33`** (el checkout respeta la fecha futura, tres de tres), **`EX-36`** (se puede cambiar la tarjeta sin recrear) y **`EX-38`** (una `start_date` futura se convierte en free trial sola) |
