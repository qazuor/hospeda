...
| 7 | [`docs/06-mp-validation-matrix.md`](./docs/06-mp-validation-matrix.md) | Qué sabemos de Mercado Pago, medido: 37 de 60 filas |
...
| FASE 1C — experimentación con Mercado Pago | 🟡 **en curso — 37 de 60 filas · reloj corriendo** |
