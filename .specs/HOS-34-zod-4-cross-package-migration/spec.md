...
# Zod 4 cross-package migration

> Migrated from `.qtm/specs/SPEC-132-zod-4-cross-package-migration/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-34.
