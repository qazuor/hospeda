...
# Security deps moderate remediation (framework bumps + overrides)

> Migrated from `.qtm/specs/SPEC-263-security-deps-moderate-remediation/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-31.
