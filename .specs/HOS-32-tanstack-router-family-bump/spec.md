...
# TanStack Router family bump (unblock production group)

> Migrated from `.qtm/specs/SPEC-234-tanstack-router-family-bump/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-32.
