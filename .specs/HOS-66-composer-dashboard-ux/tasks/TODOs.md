...
- [ ] **T-007** (complexity: 2) - Wire dashboard route + schema for date range and platform breakdown
...
- [ ] **T-004** (complexity: 2) - Integration tests for batch/campaign auto-detection acceptance criteria (AC-1/AC-2/AC-3)
