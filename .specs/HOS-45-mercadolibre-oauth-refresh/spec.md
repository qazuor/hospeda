...
# MercadoLibre OAuth refresh-token flow (make the ML import tier production-viable)

> Migrated from `.qtm/specs/SPEC-278-mercadolibre-oauth-refresh/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-45.
>
