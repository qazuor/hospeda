...
# Occupancy calendar — Phase 1 manual (basic) + Phase 2/3 external sync (advanced)

> Migrated from `.qtm/specs/SPEC-272-occupancy-calendar/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-43.
>
