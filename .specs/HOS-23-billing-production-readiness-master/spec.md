...
# Production-Ready Billing — Master Plan

> Migrated from `.qtm/specs/SPEC-122-billing-production-readiness-master/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-23.
