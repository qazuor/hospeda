...
# Per-environment OAuth credentials — Google + Facebook separate for prod and staging

> Migrated from `.qtm/specs/SPEC-112-oauth-per-env-separation/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-37.
