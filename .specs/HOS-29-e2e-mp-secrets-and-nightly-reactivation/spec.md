...
# E2E MercadoPago Secrets Bootstrap and Nightly Suite Reactivation

> Migrated from `.qtm/specs/SPEC-121-e2e-mp-secrets-and-nightly-reactivation/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-29.
...
> **Migration-time note (2026-07-01):** this cron-enable outcome overlaps with SPEC-105 (E2E Nightly Test Suite Repair, tracked as HOS-27), which already re-enabled the same cron via merged PR #1856 as part of its own repair work. Reconcile with HOS-27 before starting T-121-01/02/04/05 to avoid duplicate cron-enable effort — T-121-03 may already be satisfied.
...
- SPEC-105 / HOS-27 (E2E Nightly Test Suite Repair) — overlapping cron-enable outcome, reconcile before starting T-121-03
