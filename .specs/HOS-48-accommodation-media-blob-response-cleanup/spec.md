...
# Accommodation media: remove composed blob shape from API responses

> Migrated from `.qtm/specs/SPEC-280-accommodation-media-blob-response-cleanup/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-48.
>
