...
# Multi-unit accommodation capacity model (hotels & complexes that rent per unit)

> Migrated from `.qtm/specs/SPEC-248-multi-unit-accommodation-capacity/spec.md` on 2026-07-02 as part of the Linear tracking migration. Canonical tracking is now HOS-55.
>
