...
# Hospeda mobile app (React Native / Expo)

> **Migrated from `.qtm/specs/SPEC-243-mobile-app/spec.md` on 2026-07-01** as part
> of the Linear tracking migration. Canonical tracking is now HOS-2.

## Status — verified 2026-07-01 (do not trust the old status field below)

- **Sub-0 (Foundation)** — shipped (PR #1705).
- **Sub-3 (Host/Management)** — shipped (PRs #1708/#1709/#1710).
- **Sub-4 (Account/Profile)** — shipped (PR #1713).
- **Sub-1 (Tourist/Discovery)** — NOT started. `(tourist)/index.tsx` is a
  placeholder; no discovery/search/nearby-map screens exist.
- **Sub-2 (Tourist/Tarjeta Hospeda)** — NOT started, blocked on SPEC-242.
