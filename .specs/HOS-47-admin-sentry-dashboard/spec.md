...
# Admin Sentry errors dashboard

> Migrated from `.qtm/specs/SPEC-225-admin-sentry-dashboard/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-47.
