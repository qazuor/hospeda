...
# AI image enhancement + manual editing (crop, rotate, filters) for all entity images

> Migrated from `.qtm/specs/SPEC-273-ai-image-enhancement/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-44.
