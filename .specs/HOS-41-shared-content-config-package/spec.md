...
# Shared Config-as-Code Package — centralize curated content & catalog files

> Migrated from `.qtm/specs/SPEC-196-shared-content-config-package/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-41.
>
