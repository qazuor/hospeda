...
# Admin Navigation & URL Coverage Audit

> Migrated from `.qtm/specs/SPEC-300-admin-navigation-url-audit/spec.md` on 2026-07-01 as part of the Linear tracking migration. Canonical tracking is now HOS-14.
