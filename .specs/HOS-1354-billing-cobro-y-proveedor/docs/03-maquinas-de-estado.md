...
la pausa** —el `fin_real` lo escriben `S22` y `S25`; que `S13` y `S17` también lo escriban es
`F-8CD1-007`, sin resolver—, así que la que sostiene lo que sigue es S10. **Y una pausa por cortesía se corta además por `S6`**, si un
