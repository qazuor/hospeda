...
que haya ninguna sucesión de por medio. Si se olvida de escribir el `saldo_meses`, el desenlace es
**exactamente el mismo** que el del cierre que se olvida: ~~días firmados~~ meses firmados por `SUPER_ADMIN` que
