...
usamos**, y **las reglas de trato que salen de haberlo medido** — 96 filas, 91 medidas (recontadas
el 2026-09-25, con `EX-40`, `RC-8` y `RC-9`). **Y desde `DEC-MP-005` el proveedor que usamos es Mercado Pago, decidido**: lo que
...
**Tres de las ~~cuatro~~ cinco siguen siendo el mismo hecho: un cobro que falla.** ❌ **Y la previsión de que
