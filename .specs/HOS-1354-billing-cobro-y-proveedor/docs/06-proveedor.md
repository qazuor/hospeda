...
usamos**, y **las reglas de trato que salen de haberlo medido** — 94 filas, 90 medidas (recontadas
el 2026-09-24, con `EX-40`). **Y desde `DEC-MP-005` el proveedor que usamos es Mercado Pago, decidido**: lo que
