...
—`ABANDONED` y **`CHARGE_DECLINED`**—. Las transiciones que la cumplen son **las diez** que en
...
no se presta (`DEC-SUB-015`). Lo que se evalúa en cada una es **la condición del
§4.2**, no el
