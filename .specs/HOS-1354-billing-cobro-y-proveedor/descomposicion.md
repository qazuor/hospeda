...
| **B10** | **Addons** | ⛔ | los dos ejes, qué es una suscripción válida, el addon a costo cero —**el que se elige gratis y el que ya se venía pagando y `S20` convierte**— y el huérfano que sigue cobrando | `16` entero · `03` §8 **y `S20` de §3.2** · `02` §2.4 · `09` §3 *(tercera y cuarta comprobación)* · `19` §4 filas 13 y 13-bis | — |
