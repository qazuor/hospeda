---
title: Remediate the WCAG violations baselined by the A11y Sweep
linear: HOS-3
statusSource: linear
created: 2026-06-30
type: bugfix
...
# Remediate the WCAG violations baselined by the A11y Sweep

> **Migrated from `.qtm/specs/SPEC-308-a11y-sweep-debt-remediation/spec.md` on
